...
$$$$$$$
    ...
    *r* into Cartesian coordinate space *x* and *y*
$$$$$$$,
$$$$$$$ but does not
...
$$$$$$$)
$$$$$$$
        # PolarAxes does not use the theta transforms here
$$$$$$$,
$$$$$$$ but apply them for
...
$$$$$$$path
$$$$$$$)
$$$$$$$ or path._interpolation_steps $=$= 1
$$$$$$$:
$$$$$$$
            return Path
$$$$$$$(
...
$$$$$$$:
$$$$$$$ draw an arc.
                    # The following is complicated by Path.arc
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ being
                    # "helpful" and unwrapping the angles
$$$$$$$,
$$$$$$$ but we don't want
                    # that behavior here.
                    last_td
...
$$$$$$$
        ...
        *limits* is the view limit of the data.  The only part of
        its bounds that is used is the y limits 
$$$$$$$(
$$$$$$$for the radius limits
$$$$$$$)
$$$$$$$.
...
$$$$$$$:
$$$$$$$
            limits_scaled $= self._limits.transformed
$$$$$$$(
...
$$$$$$$
    """
    The inverse of the polar transform
$$$$$$$,
$$$$$$$ mapping Cartesian
...
$$$$$$$
        vmin
$$$$$$$,
$$$$$$$ vmax $= self.axis.get_view_interval
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
        # Use unicode rather than mathtext with \circ
$$$$$$$,
$$$$$$$ so that it will work
        # correctly with any arbitrary font 
$$$$$$$(
$$$$$$$assuming it has a degree sign
$$$$$$$)
$$$$$$$
$$$$$$$,
$$$$$$$
...
$$$$$$$
    ...
    view spans the entire circle. In such cases
$$$$$$$,
...
$$$$$$$
        self.base $= base
        self.axis $= self.base.axis $= _AxisWrapper
$$$$$$$(
$$$$$$$self.base.axis
$$$$$$$)
$$$$$$$
...
$$$$$$$,
$$$$$$$ labels are also rotated to be parallel to
...
$$$$$$$
        ...
        mode
$$$$$$$,
$$$$$$$ user_angle $= self._labelrotation
        if mode $=$= 'default'
$$$$$$$:
$$$$$$$
...
$$$$$$$
        ...
        # locator to be an AutoLocator
$$$$$$$,
$$$$$$$ so we customize it here to have ticks
...
$$$$$$$
        ...
        trans $= dest._get_text1_transform
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$[0]
...
$$$$$$$(
$$$$$$$trans + dest._text1_translate
$$$$$$$)
$$$$$$$
        trans $= dest._get_text2_transform
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$[0]
...
$$$$$$$
    ...
    Ensures that all ticks are strictly positive.  For all other tasks
$$$$$$$,
$$$$$$$ it
    delegates to the base `.Locator` 
$$$$$$$(
$$$$$$$which may be different depending on the
    scale of the *r*-axis
$$$$$$$)
$$$$$$$.
    """
...
$$$$$$$:
$$$$$$$
                    return [tick for tick in self.base
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ if tick > rorigin]
...
$$$$$$$)
$$$$$$$
        return mtransforms.nonsingular
$$$$$$$(
$$$$$$$vmin
$$$$$$$,
$$$$$$$ vmax
...
$$$$$$$,
$$$$$$$ 'rlabel'}
        Whether to shift away from the start 
$$$$$$$(
$$$$$$$``'min'``
$$$$$$$)
$$$$$$$ or the end 
...
$$$$$$$
    ...
    the spine. Labels are also rotated to be perpendicular to the spine
$$$$$$$,
$$$$$$$ when
...
$$$$$$$spine angle - 90
$$$$$$$)
$$$$$$$ because it's used for the tick
        # & text setup
$$$$$$$,
$$$$$$$ so all numbers below are -90 from 
$$$$$$$(
$$$$$$$normed
$$$$$$$)
$$$$$$$ spine angle.
...
$$$$$$$
            angle $= 
$$$$$$$(
$$$$$$$thetamin * direction + offset
$$$$$$$)
$$$$$$$ % 360 - 90
            if direction > 0
$$$$$$$:
$$$$$$$
                tick_angle $= np.deg2rad
$$$$$$$(
$$$$$$$angle
$$$$$$$)
$$$$$$$
...
$$$$$$$ r
$$$$$$$)
$$$$$$$ wedge Bbox into axes bounding box.
...
$$$$$$$:
$$$$$$$ `~matplotlib.transforms.Bbox`
        Bbox determining the origin for the wedge
$$$$$$$,
$$$$$$$ if different from *viewLim*
    """
    def __init__
$$$$$$$(
$$$$$$$self
...
$$$$$$$
            ...
            w
$$$$$$$,
$$$$$$$ h $= self._points[1] - self._points[0]
            deltah $= max
$$$$$$$(
$$$$$$$w - h
$$$$$$$,
...
$$$$$$$
    """
    A polar graph projection
$$$$$$$,
$$$$$$$ where the input dimensions are *theta*
$$$$$$$,
$$$$$$$ *r*.
...
$$$$$$$
        ...
        self.grid
$$$$$$$(
$$$$$$$rcParams['polaraxes.grid']
$$$$$$$)
$$$$$$$
        inner $= self.spines.get
$$$$$$$(
$$$$$$$'inner'
$$$$$$$,
$$$$$$$ None
...
$$$$$$$)
$$$$$$$
        # Calling polar_axes.xaxis.clear
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ or polar_axes.xaxis.clear
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
        ...
        # now.
        # self.spines['polar'].register_axis
$$$$$$$(
$$$$$$$self.yaxis
$$$$$$$)
$$$$$$$
...
$$$$$$$
        ...
        self._originViewLim $= mtransforms.LockableBbox
$$$$$$$(
$$$$$$$self.viewLim
$$$$$$$)
$$$$$$$
...
$$$$$$$
        ...
        # equivalent to transData
$$$$$$$,
$$$$$$$ except it always puts r $=$= 0.0 and r $=$= 1.0
...
$$$$$$$)
$$$$$$$
        # The theta labels are flipped along the radius
$$$$$$$,
$$$$$$$ so that text 1 is on
...
$$$$$$$
        ...
        # axis so the gridlines from 0.0 to 1.0
$$$$$$$,
$$$$$$$ now go from thetamin to
        # thetamax.
...
$$$$$$$:
$$$$$$$
        return self._xaxis_text_transform
$$$$$$$,
$$$$$$$ 'center'
$$$$$$$,
$$$$$$$ 'center'
...
$$$$$$$
        thetamin
$$$$$$$,
$$$$$$$ thetamax $= self._realViewLim.intervalx
        if _is_full_circle_rad
$$$$$$$(
$$$$$$$thetamin
$$$$$$$,
...
$$$$$$$)
$$$$$$$
        return self._yaxis_text_transform + pad_shift
$$$$$$$,
$$$$$$$ 'center'
$$$$$$$,
$$$$$$$ halign
...
$$$$$$$:
$$$$$$$ Any subclassed Axes might override the
            # patch to not be the Wedge that PolarAxes uses.
            center $= self.transWedge.transform
$$$$$$$(
$$$$$$$
$$$$$$$(
$$$$$$$0.5
...
$$$$$$$
        ...
        visible $= not _is_full_circle_deg
$$$$$$$(
$$$$$$$thetamin
$$$$$$$,
$$$$$$$ thetamax
...
$$$$$$$)
$$$$$$$
        spines['start'].set_transform
$$$$$$$(
$$$$$$$self._yaxis_transform
$$$$$$$)
$$$$$$$
        spines['end'].set_transform
$$$$$$$(
$$$$$$$self._yaxis_transform
$$$$$$$)
$$$$$$$
...
$$$$$$$,
$$$$$$$ so for example
        it is possible to do ``set_thetalim
$$$$$$$(
$$$$$$$-np.pi / 2
$$$$$$$,
$$$$$$$ np.pi / 2
...
$$$$$$$)
$$$$$$$
        # Parsing all permutations of *args
$$$$$$$,
$$$$$$$ **kwargs is tricky; it is simpler
        # to let set_xlim
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ do it and then validate the limits.
        if abs
$$$$$$$(
$$$$$$$new_max - new_min
$$$$$$$)
...
$$$$$$$
        ...
        """
        return self._theta_offset.get_matrix
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$[0
...
$$$$$$$
           Theta increases in the counterclockwise direction
        """
        return self._direction.get_matrix
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$[0
...
$$$$$$$
        return np.sign
$$$$$$$(
$$$$$$$self._originViewLim.y1 - self._originViewLim.y0
$$$$$$$)
$$$$$$$
...
$$$$$$$
                raise ValueError
$$$$$$$(
$$$$$$$'Cannot supply both positional "top"'
                                 'argument and kwarg "rmax"'
$$$$$$$)
$$$$$$$
        return self.set_ylim
$$$$$$$(
$$$$$$$bottom$=bottom
$$$$$$$,
$$$$$$$ top$=top
...
$$$$$$$
        ...
        For polar axes
$$$$$$$,
$$$$$$$ this is slightly misleading. Both panning and
...
$$$$$$$ vert1
$$$$$$$,
$$$$$$$ horiz1 $= self.get_yaxis_text1_transform
$$$$$$$(
$$$$$$$0.0
$$$$$$$)
$$$$$$$
...
$$$$$$$ vert2
$$$$$$$,
$$$$$$$ horiz2 $= self.get_yaxis_text2_transform
$$$$$$$(
$$$$$$$0.0
$$$$$$$)
$$$$$$$
...
# to keep things all self contained
$$$$$$$,
$$$$$$$ we can put aliases to the Polar classes
# defined above. This isn't strictly necessary
$$$$$$$,
$$$$$$$ but it makes some of the
# code more readable 
$$$$$$$(
$$$$$$$and provides a backwards compatible Polar API
$$$$$$$)
$$$$$$$
