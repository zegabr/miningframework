...
# NOTE
$$$$$$$:
$$$$$$$ This file must remain Python 2 compatible for the foreseeable future
$$$$$$$,
$$$$$$$
...
$$$$$$$
    error $= """
Beginning with Matplotlib {0}
$$$$$$$,
$$$$$$$ Python {1} or above is required.
...
import setupext
from setupext import print_raw
$$$$$$$,
$$$$$$$ print_status
...
$$$$$$$
        print
$$$$$$$(
$$$$$$$"Matplotlib does not support running tests with "
              "'python setup.py test'. Please run 'pytest'."
$$$$$$$)
$$$$$$$


class BuildExtraLibraries
$$$$$$$(
...
$$$$$$$
        ...
        extensions
$$$$$$$,
$$$$$$$ and to the environment variables so that vendored libraries
        will also use them. If the compiler does not support these flags
$$$$$$$,
$$$$$$$ then
        none are added.
        """
...
$$$$$$$
            return env
        enable_lto $= setupext.config.getboolean
$$$$$$$(
$$$$$$$'libs'
$$$$$$$,
$$$$$$$ 'enable_lto'
...
$$$$$$$ return them
$$$$$$$,
$$$$$$$ and also check whether LTO is disabled in each
            one
$$$$$$$,
$$$$$$$ raising an error if Matplotlib config explicitly enabled LTO.
            """
...
$$$$$$$:
$$$$$$$
        # Remove the -Wstrict-prototypes option
$$$$$$$,
$$$$$$$ it's not valid for C++.  Fixed
        # in Py3.7 as bpo-5755.
        try
$$$$$$$:
$$$$$$$
            self.compiler.compiler_so.remove
$$$$$$$(
$$$$$$$'-Wstrict-prototypes'
$$$$$$$)
$$$$$$$
...
$$$$$$$
        ...
        if 
$$$$$$$(
$$$$$$$self.compiler.compiler_type $=$= 'msvc' and
                os.environ.get
$$$$$$$(
$$$$$$$'MPL_DISABLE_FH4'
$$$$$$$)
...
$$$$$$$//devblogs.microsoft.com/cppblog/making-cpp-exception-handling-smaller-x64/
            # https
$$$$$$$:
$$$$$$$//github.com/joerick/cibuildwheel/issues/423#issuecomment-677763904
            for ext in self.extensions
$$$$$$$:
$$$$$$$
                ext.extra_compile_args.append
...
$$$$$$$:
$$$$$$$
        # When C coverage is enabled
$$$$$$$,
$$$$$$$ the path to the object file is saved.
        # Since we re-use source files in multiple extensions
$$$$$$$,
$$$$$$$ libgcov will
        # complain at runtime that it is trying to save coverage for the same
        # object file at different timestamps 
$$$$$$$(
$$$$$$$since each source is compiled
        # again for each extension
$$$$$$$)
$$$$$$$. Thus
$$$$$$$,
$$$$$$$ we need to use unique temporary
...
$$$$$$$:
$$$$$$$
    # If packagers want to change the default backend
$$$$$$$,
$$$$$$$ insert a `#backend
$$$$$$$:
$$$$$$$ ...`
...
$$$$$$$:
$$$$$$$ Agg` which has no effect
    # even after decommenting
$$$$$$$,
$$$$$$$ which allows _auto_backend_sentinel to be filled
    # in at import time.
    template_lines $= path.read_text
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$.splitlines
...
$$$$$$$
    backend_line_idx
$$$$$$$,
$$$$$$$ $= [  # Also asserts that there is a single such line.
        idx for idx
$$$$$$$,
$$$$$$$ line in enumerate
$$$$$$$(
...
# If the user just queries for information
$$$$$$$,
$$$$$$$ don't bother figuring out which
...
$$$$$$$
    print_raw
$$$$$$$(
$$$$$$$"Edit mplsetup.cfg to change the build options; "
...
$$$$$$$:
$$$$$$$
        # Extension modules only get added in build_ext
$$$$$$$,
$$$$$$$ as numpy will have
        # been installed 
$$$$$$$(
...
$$$$$$$)
$$$$$$$
            package_data[key] $= list
$$$$$$$(
$$$$$$$set
$$$$$$$(
$$$$$$$val + package_data[key]
$$$$$$$)
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$  # Finally
$$$$$$$,
$$$$$$$ pass this all along to setuptools to do the heavy lifting.
    name$="matplotlib"
$$$$$$$,
$$$$$$$
...
$$$$$$$ 'https
$$$$$$$:
$$$$$$$//numfocus.org/donate-to-matplotlib'
    }
$$$$$$$,
$$$$$$$
