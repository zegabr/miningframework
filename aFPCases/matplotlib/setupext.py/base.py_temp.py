...
$$$$$$$:
$$$$$$$ list[str]
        URLs from which download is attempted 
$$$$$$$(
$$$$$$$in order of attempt
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$ str
        SHA256 hash of the tarball; used both as a cache key 
$$$$$$$(
$$$$$$$by
        `get_from_cache_or_download`
$$$$$$$)
$$$$$$$ and to validate a downloaded tarball.
    dirname 
$$$$$$$:
$$$$$$$ path-like
...
$$$$$$$
$$$$$$$:
$$$$$$$  # Download it or load it from cache.
        Path
$$$$$$$(
$$$$$$$"build"
$$$$$$$)
...
$$$$$$$:
$$$$$$$
                tar_contents $= get_from_cache_or_download
$$$$$$$(
$$$$$$$url
$$$$$$$,
$$$$$$$ sha
...
$$$$$$$(
$$$$$$$
                f"Failed to download any of the following
$$$$$$$:
$$$$$$$ {urls}.  "
...
# embedded windows build script 
$$$$$$$(
$$$$$$$grep for "REMINDER" in this file
$$$$$$$)
$$$$$$$
LOCAL_FREETYPE_VERSION $= '2.6.1'
LOCAL_FREETYPE_HASH $= _freetype_hashes.get
$$$$$$$(
...
$$$$$$$,
$$$$$$$ which can be altered using mplsetup.cfg
mplsetup_cfg $= os.environ.get
$$$$$$$(
$$$$$$$'MPLSETUPCFG'
$$$$$$$)
$$$$$$$ or 'mplsetup.cfg'
...
$$$$$$$ 'system_freetype'
$$$$$$$,
$$$$$$$ fallback$=sys.platform.startswith
$$$$$$$(
$$$$$$$'aix'
$$$$$$$)
$$$$$$$
...
$$$$$$$
        return None
    pkg_config_path $= sysconfig.get_config_var
$$$$$$$(
$$$$$$$'LIBDIR'
$$$$$$$)
$$$$$$$
...
$$$$$$$
    ...
    # First
$$$$$$$,
$$$$$$$ try to get the flags from pkg-config.
...
$$$$$$$
    cmd $= [pkg_config
$$$$$$$,
$$$$$$$ package] if pkg_config else alt_exec
    if cmd is not None
$$$$$$$:
$$$$$$$
        try
...
$$$$$$$
                    [*cmd
$$$$$$$,
$$$$$$$ f"--atleast-version$={atleast_version}"]
$$$$$$$)
$$$$$$$
...
$$$$$$$ fall back on the defaults.
    ...
    # https
$$$$$$$:
$$$$$$$//github.com/conda/conda/issues/2312 re
$$$$$$$:
$$$$$$$ getting the env dir.
    if sys.platform $=$= 'win32'
$$$$$$$:
...
$$$$$$$)
$$$$$$$  # conda < 4.1
        if conda_env_path and os.path.isdir
$$$$$$$(
$$$$$$$conda_env_path
$$$$$$$)
$$$$$$$
...
$$$$$$$str
$$$$$$$(
$$$$$$$conda_env_path / "Library/include"
$$$$$$$)
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$ or
        ...
        If the package should be skipped
$$$$$$$,
$$$$$$$ raise a `Skipped` exception.

        If a missing build dependency is fatal
$$$$$$$,
$$$$$$$ call `sys.exit`.
        """
...
$$$$$$$
        """
        Return or yield a list of C extensions 
$$$$$$$(
$$$$$$$`distutils.core.Extension`
        objects
$$$$$$$)
$$$$$$$ to add to the configuration.  These are added to the
...
$$$$$$$
        """
        If a package needs to do extra custom things
$$$$$$$,
$$$$$$$ such as building a
        third-party library
$$$$$$$,
...
$$$$$$$
    """Glob "lib/$pkg/$subdir/**/*"
$$$$$$$,
$$$$$$$ returning paths relative to "lib/$pkg"."""
    base $= Path
$$$$$$$(
$$$$$$$"lib"
$$$$$$$,
...
$$$$$$$
                '*.dll'
$$$$$$$,
$$$$$$$  # Only actually matters on Windows.
            ]
$$$$$$$,
$$$$$$$
        }
...
$$$$$$$:
$$$$$$$
    # We need a patched Agg not available elsewhere
$$$$$$$,
$$$$$$$ so always use the vendored
    # version.
    ext.include_dirs.insert
$$$$$$$(
$$$$$$$0
$$$$$$$,
...
def add_libagg_flags_and_sources
$$$$$$$(
$$$$$$$ext
$$$$$$$)
$$$$$$$
...
# First compile checkdep_freetype2.c
$$$$$$$,
$$$$$$$ which aborts the compilation either
# with "foo.h
$$$$$$$:
$$$$$$$ No such file or directory" if the header is not found
$$$$$$$,
$$$$$$$ or an
...
$$$$$$$
                ...
                # from the tarball.  For FreeType>$=2.4
$$$$$$$,
...
$$$$$$$
        ...
        print
$$$$$$$(
$$$$$$$f"Building freetype in {src_path}"
$$$$$$$)
$$$$$$$
        if sys.platform !$= 'win32'
$$$$$$$:
$$$$$$$  # compilation on non-windows
            env $= {**env
$$$$$$$,
$$$$$$$ "CFLAGS"
$$$$$$$:
...
$$$$$$$
            # https
$$$$$$$:
$$$$$$$//developercommunity.visualstudio.com/comments/190992/view.html
            
$$$$$$$(
$$$$$$$sln_path.parent / "Directory.Build.props"
$$$$$$$)
$$$$$$$.write_text
$$$$$$$(
$$$$$$$"""
...
$$$$$$$
            ...
            # into msbuild command
$$$$$$$,
$$$$$$$ and Directory.Build.props will not override
            # the value in the project file.
            # The DefaultPlatformToolset is from Microsoft.Cpp.Default.props
            with open
$$$$$$$(
$$$$$$$base_path / vc / "freetype.vcxproj"
$$$$$$$,
$$$$$$$ 'r+b'
$$$$$$$)
$$$$$$$ as f
$$$$$$$:
$$$$$$$
                toolset_repl $= b'PlatformToolset>$
$$$$$$$(
...
$$$$$$$
$$$$$$$)
$$$$$$$  # Get msbuild in the %PATH% of cc.spawn.
            cc.spawn
$$$$$$$(
$$$$$$$["msbuild"
$$$$$$$,
...
$$$$$$$
                      f"/p
$$$$$$$:
$$$$$$$Configuration$=Release;Platform$={msbuild_platform}"]
$$$$$$$)
$$$$$$$
...
$$$$$$$ $= 
$$$$$$$(
$$$$$$$src_path / "objs" / vc / msbuild_platform
$$$$$$$)
$$$$$$$.glob
$$$$$$$(
$$$$$$$
...
$$$$$$$lib_path
$$$$$$$,
$$$$$$$ src_path / "objs/.libs/libfreetype.lib"
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
            cls._extensions_to_update.append
$$$$$$$(
$$$$$$$ext
$$$$$$$)
$$$$$$$
...
$$$$$$$
            urls$=["http
$$$$$$$:
$$$$$$$//www.qhull.org/download/qhull-2020-src-8.0.2.tgz"]
$$$$$$$,
$$$$$$$
...
$$$$$$$
            qhull_path $= Path
$$$$$$$(
$$$$$$$f'build/qhull-{LOCAL_QHULL_VERSION}/src'
$$$$$$$)
$$$$$$$
            ext.include_dirs.insert
$$$$$$$(
