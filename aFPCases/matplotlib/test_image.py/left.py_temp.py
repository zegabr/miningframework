...
$$$$$$$:
$$$$$$$
    """Make the basic nearest
$$$$$$$,
$$$$$$$ bilinear and bicubic interps."""
...
$$$$$$$
    ...
    # visible. This works fine with pdf
$$$$$$$,
$$$$$$$ since the dpi setting doesn't
    # affect anything but images
$$$$$$$,
$$$$$$$ but the agg output becomes unusably
    # small.
...
$$$$$$$:
$$$$$$$
    # should be less than 3 upsample
$$$$$$$,
$$$$$$$ so should be nearest...
    np.random.seed
$$$$$$$(
$$$$$$$19680801
$$$$$$$)
...
$$$$$$$__file__
$$$$$$$)
$$$$$$$.parent / "baseline_images/pngsuite/basn3p04.png"
    tiff_path $= Path
$$$$$$$(
$$$$$$$__file__
$$$$$$$)
$$$$$$$.parent / "baseline_images/test_image/uint16.tif"
...
$$$$$$$ "jpeg"]
    ...
    # for the image
$$$$$$$,
$$$$$$$ but this will not actually add any extra pixels
    # to the image
$$$$$$$,
$$$$$$$ it will merely be used for metadata purposes.

    # So we do the traditional case 
$$$$$$$(
$$$$$$$dpi $=$= 1
$$$$$$$)
$$$$$$$
...
$$$$$$$dpi
    # $=$= 100
$$$$$$$)
$$$$$$$ and read the resulting PNG files back in and make sure
...
$$$$$$$
    ...
    # color and alpha without raising any exceptions
$$$$$$$,
...
$$$$$$$ is None
    ...
    # Hmm
$$$$$$$,
$$$$$$$ something is wrong here... I get 0
$$$$$$$,
$$$$$$$ not None...
    # But
$$$$$$$,
$$$$$$$ this works further down in the tests with extents flipped
    # x
$$$$$$$,
$$$$$$$ y $= 0.1
$$$$$$$,
...
$$$$$$$:
$$$$$$$
    imgData $= [[1 / x + 1 / y for x in range
$$$$$$$(
$$$$$$$1
$$$$$$$,
$$$$$$$ 100
...
$$$$$$$
    ...
    assert g !$= 100
$$$$$$$,
$$$$$$$ 'Expected a non-green edge - but sadly
$$$$$$$,
$$$$$$$ it was.'
...
$$$$$$$)
$$$$$$$
    # returns the correct bounding box values 
$$$$$$$(
$$$$$$$in pixels
$$$$$$$)
$$$$$$$.
...
$$$$$$$
    ...
    im_bbox $= im_obj.get_window_extent
$$$$$$$(
$$$$$$$renderer
$$$$$$$)
$$$$$$$
...
$$$$$$$. If this
    # is working
$$$$$$$,
$$$$$$$ we should have all 256 shades of grey represented.
    num_colors $= len
$$$$$$$(
$$$$$$$image.getcolors
$$$$$$$(
...
$$$$$$$
    ...
    # only as thick as the colorbar
$$$$$$$,
$$$$$$$ and doesn't extend to other parts
    # of the image.  See #5814.  While the original bug exists only
    # in Postscript
$$$$$$$,
$$$$$$$ the best way to detect it is to generate SVG
...
# backend was modified to use indexed color
$$$$$$$,
$$$$$$$ there are ten pixels that differ
...
$$$$$$$  # difference of Gaussians
    ...
    palette $= plt.cm.gray.with_extremes
$$$$$$$(
$$$$$$$over$='r'
$$$$$$$,
$$$$$$$ under$='g'
...
$$$$$$$:
$$$$$$$
    # Test mask image two ways
$$$$$$$:
$$$$$$$ Using nans and using a masked array.
...
$$$$$$$s
$$$$$$$)
$$$$$$$ for s in 'u2 u4 i2 i4 i8 f4 f8'.split
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$]
...
$$$$$$$)
$$$$$$$
    # Make the image invisible in axs[1]
$$$$$$$,
$$$$$$$ but visible in axs[0] if we pan
    # axs[1] up.
    im.set_clip_box
$$$$$$$(
$$$$$$$axs[0].bbox
...
$$$$$$$'https
$$$$$$$:
$$$$$$$//matplotlib.org/1.5.0/_static/logo2.png'
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
        ax_ref[i].title.set_y
$$$$$$$(
$$$$$$$1.05
$$$$$$$)
$$$$$$$
        ax_ref[i].xaxis.set_ticks_position
$$$$$$$(
$$$$$$$'both'
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
        # NonUniformImage "leaks" out of extents
$$$$$$$,
$$$$$$$ not PColorImage.
        ax.set
$$$$$$$(
...
$$$$$$$
    ...
    # rgba antialias
$$$$$$$:
$$$$$$$ Note purples at boundary with circle.  Note that
