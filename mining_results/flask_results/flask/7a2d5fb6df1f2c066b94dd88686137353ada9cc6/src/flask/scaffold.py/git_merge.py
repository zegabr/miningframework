...
<<<<<<< ./flask/7a2d5fb6df1f2c066b94dd88686137353ada9cc6/src/flask/scaffold.py/left.py
    @setupmethod
    def get(self, rule: str, **options: t.Any) -> t.Callable[[F], F]:
||||||| ./flask/7a2d5fb6df1f2c066b94dd88686137353ada9cc6/src/flask/scaffold.py/base.py
    def get(self, rule: str, **options: t.Any) -> t.Callable[[F], F]:
=======
    def get(
        self, rule: str, **options: t.Any
    ) -> t.Callable[[ft.RouteDecorator], ft.RouteDecorator]:
>>>>>>> ./flask/7a2d5fb6df1f2c066b94dd88686137353ada9cc6/src/flask/scaffold.py/right.py
