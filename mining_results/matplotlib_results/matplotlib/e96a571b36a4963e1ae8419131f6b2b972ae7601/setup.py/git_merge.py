...
setup(  # Finally, pass this all along to setuptools to do the heavy lifting.
    ...
    setup_requires=[
        "certifi>=2020.06.20",
<<<<<<< ./matplotlib/e96a571b36a4963e1ae8419131f6b2b972ae7601/setup.py/left.py
        "numpy>=1.19",
        "setuptools_scm>=7",
||||||| ./matplotlib/e96a571b36a4963e1ae8419131f6b2b972ae7601/setup.py/base.py
        "numpy>=1.17",
        "setuptools_scm>=4",
...
=======
        ...
        "setuptools_scm>=4,<7",
        "setuptools_scm_git_archive",
>>>>>>> ./matplotlib/e96a571b36a4963e1ae8419131f6b2b972ae7601/setup.py/right.py
    ],
    install_requires=[
        "contourpy>=1.0.1",
        "cycler>=0.10",
