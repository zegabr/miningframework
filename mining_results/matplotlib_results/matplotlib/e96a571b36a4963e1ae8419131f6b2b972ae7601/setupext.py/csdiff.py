...
options = {
    ...
    'system_freetype': config.getboolean(
        ...
        fallback=sys.platform.startswith(('aix'
<<<<<<< ./matplotlib/e96a571b36a4963e1ae8419131f6b2b972ae7601/setupext.py/left.py
, 'os400')
=======
, 'os400'
>>>>>>> ./matplotlib/e96a571b36a4963e1ae8419131f6b2b972ae7601/setupext.py/right.py
)
    )
    ),
