...
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/pip.py/left.py
                logger.error("Can't parse line '%s'", line)
||||||| ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/pip.py/base.py
                logger.error("Can't parse line '{0}'".format(line))
=======
                logger.error("Can't parse line %r", line)
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/pip.py/right.py
                continue
            packages[name] = version_
