...
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/rh_ip.py/left.py
...
||||||| ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/rh_ip.py/base.py
    # ARP targets in n.n.n.n form
    valid = ["list of ips (up to 16)"]
    if "arp_ip_target" in opts:
        if isinstance(opts["arp_ip_target"], list):
...
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/rh_ip.py/right.py
            else:
                _raise_error_iface(iface, "arp_ip_target", valid)
        else:
            _raise_error_iface(iface, "arp_ip_target", valid)
