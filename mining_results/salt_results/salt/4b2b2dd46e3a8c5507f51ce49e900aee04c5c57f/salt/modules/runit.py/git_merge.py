...
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/runit.py/left.py
            except IOError:
                log.error("Unable to create file %s", down_file)
||||||| ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/runit.py/base.py
            except IOError:
                log.error("Unable to create file {0}".format(down_file))
=======
            except OSError:
                log.error("Unable to create file %s", down_file)
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/runit.py/right.py
                return False
