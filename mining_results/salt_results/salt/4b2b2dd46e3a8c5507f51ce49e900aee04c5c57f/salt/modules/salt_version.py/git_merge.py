...
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/salt_version.py/left.py
        log.info("Release codename %s was not found.", name)
||||||| ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/salt_version.py/base.py
        log.info("Release code name {} was not found.".format(name))
=======
        log.info("Release code name %s was not found.", name)
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/salt_version.py/right.py
        return None
