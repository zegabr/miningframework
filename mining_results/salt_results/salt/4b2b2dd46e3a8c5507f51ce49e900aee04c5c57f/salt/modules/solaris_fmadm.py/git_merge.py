...
def _parse_fmdump_verbose(output):
    ...
    for line in output:
        if line.startswith("TIME"):
            ...
            if line.strip() == "":
                continue
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/solaris_fmadm.py/left.py
            verbose_fault["details"] = "{0}{1}\n".format(verbose_fault["details"], line)
    if verbose_fault:
||||||| ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/solaris_fmadm.py/base.py
            verbose_fault["details"] = "{0}{1}\n".format(verbose_fault["details"], line)
    if len(verbose_fault) > 0:
=======
            verbose_fault["details"] = "{}{}\n".format(verbose_fault["details"], line)
    if len(verbose_fault) > 0:
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/solaris_fmadm.py/right.py
        result.append(verbose_fault)
