...
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/solr.py/left.py
        if not extra:
            return "http://{0}:{1}{2}/{3}?wt=json".format(host, port, baseurl, handler)
||||||| ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/solr.py/base.py
        if extra is None or len(extra) == 0:
            return "http://{0}:{1}{2}/{3}?wt=json".format(host, port, baseurl, handler)
=======
        if extra is None or len(extra) == 0:
            return "http://{}:{}{}/{}?wt=json".format(host, port, baseurl, handler)
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/solr.py/right.py
        else:
