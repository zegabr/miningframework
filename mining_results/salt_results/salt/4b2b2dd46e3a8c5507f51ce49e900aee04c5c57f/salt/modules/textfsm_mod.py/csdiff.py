...
def extract(template_path, raw_text=None, raw_text_file=None, saltenv="base"):
    ...
    log.debug(
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/textfsm_mod.py/left.py
"Using the saltenv: %s", saltenv)
=======
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/textfsm_mod.py/right.py
        "Caching %s(
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/textfsm_mod.py/left.py
"Caching %s using the Salt fileserver", template_path
=======
saltenv: %s) using the Salt fileserver", template_path, saltenv
...
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/textfsm_mod.py/right.py
        "Caching %s(
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/textfsm_mod.py/left.py
"Caching %s using the Salt fileserver", textfsm_path
=======
saltenv: %s) using the Salt fileserver", textfsm_path, saltenv
