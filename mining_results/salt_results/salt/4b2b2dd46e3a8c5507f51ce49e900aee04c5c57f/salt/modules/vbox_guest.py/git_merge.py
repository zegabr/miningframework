...
def additions_version():
    ...
    try:
        ...
        return False
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vbox_guest.py/left.py
    if d and os.listdir(d):
        return re.sub(r"^{0}-".format(_additions_dir_prefix), "", os.path.basename(d))
||||||| ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vbox_guest.py/base.py
    if d and len(os.listdir(d)) > 0:
        return re.sub(r"^{0}-".format(_additions_dir_prefix), "", os.path.basename(d))
=======
    if d and len(os.listdir(d)) > 0:
        return re.sub(r"^{}-".format(_additions_dir_prefix), "", os.path.basename(d))
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vbox_guest.py/right.py
    return False
