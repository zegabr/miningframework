...
def _get_dvs_infrastructure_traffic_resources(dvs_name, dvs_infra_traffic_ress):
    ...
    """
    log.trace(
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vsphere.py/left.py
        "Building the dicts of the DVS '%s' infrastructure traffic resources", dvs_name,
=======
        "Building the dicts of the DVS '%s' infrastructure traffic resources"
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vsphere.py/right.py
, dvs_name
    )
    res_dicts = []
...
def _apply_dvportgroup_security_policy(pg_name, sec_policy, sec_policy_conf):
    ...
    log.trace(
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vsphere.py/left.py
"Building portgroup's '%s' security policy ", pg_name
=======
"Building portgroup's '%s' security policy", pg_name
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vsphere.py/right.py
)
...
def remove_dvportgroup(portgroup, dvs, service_instance=None):
    ...
    log.trace(
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vsphere.py/left.py
"Removing portgroup'%s' in dvs '%s'", portgroup
=======
"Removing portgroup '%s' in dvs '%s'", portgroup
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vsphere.py/right.py
, dvs)
...
def list_disks(disk_ids=None, scsi_addresses=None, service_instance=None):
    ...
    log.trace(
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vsphere.py/left.py
"Retrieving disks if host '%s'", hostname)
=======
...
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vsphere.py/right.py
        scsi_addresses,
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/vsphere.py/left.py
("scsi_addresses = %s", scsi_addresses
=======
