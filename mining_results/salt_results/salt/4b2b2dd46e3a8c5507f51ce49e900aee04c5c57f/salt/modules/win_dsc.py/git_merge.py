...
def compile_config(
    ...
    if source:
        ...
        if not cached_files:
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/win_dsc.py/left.py
            error = "Failed to cache {0}".format(source)
            log.error("DSC: %s", error)
||||||| ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/win_dsc.py/base.py
            error = "Failed to cache {0}".format(source)
            log.error("DSC: {0}".format(error))
=======
            error = "Failed to cache {}".format(source)
            log.error("DSC: %s", error)
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/win_dsc.py/right.py
