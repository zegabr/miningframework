...
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/win_groupadd.py/left.py
        log.warning("The group %s does not exist.", name)
||||||| ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/win_groupadd.py/base.py
        log.warning("The group {0} does not exists.".format(name))
=======
        log.warning("The group %s does not exists.", name)
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/win_groupadd.py/right.py
        return False
