...
<<<<<<< ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/win_pkg.py/left.py
        log.error("%s '%s': %s ", prefix_msg, short_path_name, error_msg)
||||||| ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/win_pkg.py/base.py
        log.error("{0} '{1}': {2} ".format(prefix_msg, short_path_name, error_msg))
=======
        log.error("%s '%s': %s", prefix_msg, short_path_name, error_msg)
>>>>>>> ./salt/4b2b2dd46e3a8c5507f51ce49e900aee04c5c57f/salt/modules/win_pkg.py/right.py
