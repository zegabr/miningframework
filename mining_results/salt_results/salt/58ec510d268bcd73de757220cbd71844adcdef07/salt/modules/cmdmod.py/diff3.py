...
<<<<<<< ./salt/58ec510d268bcd73de757220cbd71844adcdef07/salt/modules/cmdmod.py/left.py
                env_cmd = ["su", "-", runas, "-c"]
=======
                env_cmd = ["su", "-", runas, "-c"]
            else:
...
>>>>>>> ./salt/58ec510d268bcd73de757220cbd71844adcdef07/salt/modules/cmdmod.py/right.py
            else:
<<<<<<< ./salt/58ec510d268bcd73de757220cbd71844adcdef07/salt/modules/cmdmod.py/left.py
                env_cmd = ["su", "-s", shell, "-", runas, "-c"]
