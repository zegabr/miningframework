            ...
            if "result" not in ret or ret["result"] is False:
                ...
                if self.mocked:
                    ...
                    if not low.get("__prereq__") and low.get("parallel"):
                        ...
                        self.format_slots(cdata)
<<<<<<< ./salt/5c8b2083b4022915610024e026d793f63736b093/salt/state.py/left.py
...
||||||| ./salt/5c8b2083b4022915610024e026d793f63736b093/salt/state.py/base.py
                        ret = self.states[cdata["full"]](
                            *cdata["args"], **cdata["kwargs"]
                        )
=======
...
>>>>>>> ./salt/5c8b2083b4022915610024e026d793f63736b093/salt/state.py/right.py
