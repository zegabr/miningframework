...
<<<<<<< ./salt/a9fd7415a4296d9107ba88ffd584e3a7f51e0b72/salt/modules/mongodb.py/left.py
        log.error("Creating database %s failed with error: %s", name, err)
        return False
||||||| ./salt/a9fd7415a4296d9107ba88ffd584e3a7f51e0b72/salt/modules/mongodb.py/base.py
        log.error("Creating database %s failed with error: %s", name, err)
        return str(err)
=======
        log.error("Creating user %s failed with error: %s", name, err)
        return str(err)
>>>>>>> ./salt/a9fd7415a4296d9107ba88ffd584e3a7f51e0b72/salt/modules/mongodb.py/right.py
    return True
