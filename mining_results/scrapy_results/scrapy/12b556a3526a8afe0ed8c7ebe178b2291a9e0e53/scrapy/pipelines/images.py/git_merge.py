...
<<<<<<< ./scrapy/12b556a3526a8afe0ed8c7ebe178b2291a9e0e53/scrapy/pipelines/images.py/left.py
        if image.format == "PNG" and image.mode == "RGBA":
            background = self._Image.new("RGBA", image.size, (255, 255, 255))
||||||| ./scrapy/12b556a3526a8afe0ed8c7ebe178b2291a9e0e53/scrapy/pipelines/images.py/base.py
        if image.format == 'PNG' and image.mode == 'RGBA':
            background = self._Image.new('RGBA', image.size, (255, 255, 255))
=======
        if image.format in ('PNG', 'WEBP') and image.mode == 'RGBA':
            background = self._Image.new('RGBA', image.size, (255, 255, 255))
>>>>>>> ./scrapy/12b556a3526a8afe0ed8c7ebe178b2291a9e0e53/scrapy/pipelines/images.py/right.py
