...
class ShellTest(ProcessTest, SiteTest, unittest.TestCase):
    ...
    def test_dns_failures(self):
        ...
        self.assertEqual(errcode, 1, out or err)
<<<<<<< ./scrapy/12b556a3526a8afe0ed8c7ebe178b2291a9e0e53/tests/test_command_shell.py/left.py
        self.assertIn(b"DNS lookup failed", err)
||||||| ./scrapy/12b556a3526a8afe0ed8c7ebe178b2291a9e0e53/tests/test_command_shell.py/base.py
        self.assertIn(b'DNS lookup failed', err)
=======
        self.assertIn(b'DNS lookup failed', err)
...
>>>>>>> ./scrapy/12b556a3526a8afe0ed8c7ebe178b2291a9e0e53/tests/test_command_shell.py/right.py
