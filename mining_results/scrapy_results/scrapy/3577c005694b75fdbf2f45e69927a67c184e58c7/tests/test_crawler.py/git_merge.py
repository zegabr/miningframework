...
<<<<<<< ./scrapy/3577c005694b75fdbf2f45e69927a67c184e58c7/tests/test_crawler.py/left.py
                runner = CrawlerRunner(settings={
||||||| ./scrapy/3577c005694b75fdbf2f45e69927a67c184e58c7/tests/test_crawler.py/base.py
                CrawlerRunner(settings={
                    "TWISTED_REACTOR": "twisted.internet.asyncioreactor.AsyncioSelectorReactor",
                })
...
=======
    ...
    def test_crawler_process_asyncio_enabled_true(self):
        with LogCapture(level=logging.DEBUG) as log:
            if self.reactor_pytest == 'asyncio':
                runner = CrawlerProcess(settings={
>>>>>>> ./scrapy/3577c005694b75fdbf2f45e69927a67c184e58c7/tests/test_crawler.py/right.py
                    "TWISTED_REACTOR": "twisted.internet.asyncioreactor.AsyncioSelectorReactor",
                })
                yield runner.crawl(NoRequestsSpider)
