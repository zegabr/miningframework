...
install_requires = [
<<<<<<< ./scrapy/9272c4af0c6091b72da7fbdbde5cd82abc7d55e2/setup.py/left.py
    'Twisted>=18.9.0',
    'cryptography>=3.4.6',
    'cssselect>=0.9.1',
    'itemloaders>=1.0.1',
...
||||||| ./scrapy/9272c4af0c6091b72da7fbdbde5cd82abc7d55e2/setup.py/base.py
    'Twisted>=18.9.0',
    'cryptography>=3.4.6',
    'cssselect>=0.9.1',
    'itemloaders>=1.0.1',
...
=======
    ...
    "tldextract",
    "lxml>=4.3.0",
>>>>>>> ./scrapy/9272c4af0c6091b72da7fbdbde5cd82abc7d55e2/setup.py/right.py
]
extras_require = {}
