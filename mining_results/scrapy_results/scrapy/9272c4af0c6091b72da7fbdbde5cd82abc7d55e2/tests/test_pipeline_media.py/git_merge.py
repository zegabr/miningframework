...
<<<<<<< ./scrapy/9272c4af0c6091b72da7fbdbde5cd82abc7d55e2/tests/test_pipeline_media.py/left.py
    assert request.callback is NO_CALLBACK
    response = request.meta.get('response')
||||||| ./scrapy/9272c4af0c6091b72da7fbdbde5cd82abc7d55e2/tests/test_pipeline_media.py/base.py
    response = request.meta.get('response')
=======
    response = request.meta.get("response")
>>>>>>> ./scrapy/9272c4af0c6091b72da7fbdbde5cd82abc7d55e2/tests/test_pipeline_media.py/right.py
