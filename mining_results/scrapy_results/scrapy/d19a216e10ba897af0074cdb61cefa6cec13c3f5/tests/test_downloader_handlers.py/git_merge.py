...
class FileTestCase(unittest.TestCase):
    ...
    def setUp(self):
<<<<<<< ./scrapy/d19a216e10ba897af0074cdb61cefa6cec13c3f5/tests/test_downloader_handlers.py/left.py
        self.tmpname = Path(self.mktemp() + '^')
        Path(self.tmpname).write_text('0123456789')
||||||| ./scrapy/d19a216e10ba897af0074cdb61cefa6cec13c3f5/tests/test_downloader_handlers.py/base.py
...
=======
        ...
        with open(self.tmpname + '^', 'w') as f:
            f.write('0123456789')
>>>>>>> ./scrapy/d19a216e10ba897af0074cdb61cefa6cec13c3f5/tests/test_downloader_handlers.py/right.py
