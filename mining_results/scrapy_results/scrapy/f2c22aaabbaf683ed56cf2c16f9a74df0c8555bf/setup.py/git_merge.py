...
install_requires = [
<<<<<<< ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/setup.py/left.py
    "Twisted>=18.9.0",
    "cryptography>=3.4.6",
    "cssselect>=0.9.1",
    "itemloaders>=1.0.1",
    ...
    "tldextract",
    "lxml>=4.3.0",
||||||| ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/setup.py/base.py
    'Twisted>=18.9.0',
    'cryptography>=3.3',
    'cssselect>=0.9.1',
    'itemloaders>=1.0.1',
...
=======
    ...
    'tldextract',
    'lxml>=4.3.0',
>>>>>>> ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/setup.py/right.py
]
extras_require = {}
