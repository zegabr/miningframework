...
class CrawlTestCase(TestCase):
    ...
    def test_retry_dns_error(self):
        ...
        crawler = get_crawler(SimpleSpider)
        with LogCapture() as log:
<<<<<<< ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_crawl.py/left.py
            # try to fetch the homepage of a nonexistent domain
            yield crawler.crawl(
                "http://dns.resolution.invalid./", mockserver=self.mockserver
            )
||||||| ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_crawl.py/base.py
            # try to fetch the homepage of a non-existent domain
            yield crawler.crawl("http://dns.resolution.invalid./", mockserver=self.mockserver)
=======
            # try to fetch the homepage of a nonexistent domain
            yield crawler.crawl("http://dns.resolution.invalid./", mockserver=self.mockserver)
>>>>>>> ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_crawl.py/right.py
        self._assert_retried(log)
