...
<<<<<<< ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_downloadermiddleware_useragent.py/left.py
        # settings USER_AGENT to None should remove the user agent
        spider, mw = self.get_spider_and_mw("default_useragent")
||||||| ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_downloadermiddleware_useragent.py/base.py
        # settings UESR_AGENT to None should remove the user agent
        spider, mw = self.get_spider_and_mw('default_useragent')
=======
        # settings USER_AGENT to None should remove the user agent
        spider, mw = self.get_spider_and_mw('default_useragent')
>>>>>>> ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_downloadermiddleware_useragent.py/right.py
