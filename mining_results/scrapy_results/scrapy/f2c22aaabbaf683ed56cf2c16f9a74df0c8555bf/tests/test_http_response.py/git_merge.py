...
class TextResponseTest(BaseResponseTest):
    ...
    def test_follow_selector(self):
        ...
        urls = [
<<<<<<< ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_http_response.py/left.py
...
||||||| ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_http_response.py/base.py
            'http://example.com/sample2.html',
            'http://example.com/sample3.html',
            'http://example.com/sample3.html',
            'http://example.com/sample3.html#foo',
...
=======
            ...
            'http://www.google.com/something',
            'http://example.com/innertag.html'
>>>>>>> ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_http_response.py/right.py
        ]
