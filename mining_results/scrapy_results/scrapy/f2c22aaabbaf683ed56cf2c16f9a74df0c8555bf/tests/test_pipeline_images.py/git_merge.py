...
<<<<<<< ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_pipeline_images.py/left.py
...
||||||| ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_pipeline_images.py/base.py
...
=======
                expected_warning_msg = ('.convert_image() method overridden in a deprecated way, '
                                        'overridden method does not accept response_body argument.')
                self.assertEqual(len([warning for warning in w if expected_warning_msg in str(warning.message)]), 1)
>>>>>>> ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_pipeline_images.py/right.py
