...
class CrawlTestCase(TestCase):
    ...
    def test_downloader_middleware_override_request_in_process_response(self):
        ...
        * The "crawled" log message should show the overridden response.request
        ...
        log.check_present(
<<<<<<< ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_request_attribute_binding.py/left.py
            (
                "scrapy.core.engine",
                "DEBUG",
                f"Crawled (200) <GET {OVERRIDDEN_URL}> (referer: None)",
            ),
||||||| ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_request_attribute_binding.py/base.py
...
>>>>>>> ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_request_attribute_binding.py/right.py
        )
