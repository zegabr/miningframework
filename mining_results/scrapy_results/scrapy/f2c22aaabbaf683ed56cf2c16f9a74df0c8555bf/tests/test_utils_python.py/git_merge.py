...
<<<<<<< ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_utils_python.py/left.py
        # nonexistent attributes
        self.assertFalse(equal_attributes(a, b, ["x", "y"]))
||||||| ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_utils_python.py/base.py
        # not existent attributes
        self.assertFalse(equal_attributes(a, b, ['x', 'y']))
=======
        # nonexistent attributes
        self.assertFalse(equal_attributes(a, b, ['x', 'y']))
>>>>>>> ./scrapy/f2c22aaabbaf683ed56cf2c16f9a74df0c8555bf/tests/test_utils_python.py/right.py
