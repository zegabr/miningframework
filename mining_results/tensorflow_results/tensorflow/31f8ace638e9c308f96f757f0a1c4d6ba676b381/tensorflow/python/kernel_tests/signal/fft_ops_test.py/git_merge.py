...
class BaseFFTOpsTest(test.TestCase):
  ...
  def _check_grad_complex(self, func, x, y, result_is_complex=True,
                          rtol=1e-2, atol=1e-2):
<<<<<<< ./tensorflow/31f8ace638e9c308f96f757f0a1c4d6ba676b381/tensorflow/python/kernel_tests/signal/fft_ops_test.py/left.py
    with self.cached_session(use_gpu=True):
||||||| ./tensorflow/31f8ace638e9c308f96f757f0a1c4d6ba676b381/tensorflow/python/kernel_tests/signal/fft_ops_test.py/base.py
...
>>>>>>> ./tensorflow/31f8ace638e9c308f96f757f0a1c4d6ba676b381/tensorflow/python/kernel_tests/signal/fft_ops_test.py/right.py
      def f(inx, iny):
