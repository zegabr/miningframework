...
$$$$$$$rfc
$$$$$$$:
$$$$$$$`822` strings. This is the same as the HTTP
        date format.
    -   
$$$$$$$:
$$$$$$$class
...
$$$$$$$`json.JSONEncoder.default`. Python does not support
        ...
        serialized
$$$$$$$,
$$$$$$$ they are handled before this method.
...
$$$$$$$param app
$$$$$$$:
$$$$$$$ Use this app's config instead of the active app context
        or defaults.
...
$$$$$$$ 2.0
        ...
        must be text mode
$$$$$$$,
$$$$$$$ or binary mode with UTF-8 bytes.
...
$$$$$$$,
$$$$$$$ making this safe to use in HTML
$$$$$$$,
$$$$$$$
        ``<script>`` tags
$$$$$$$,
$$$$$$$ and single-quoted attributes without further
        escaping.
...
$$$$$$$
$$$$$$$"
$$$$$$$Serialize data to JSON and wrap it in a 
$$$$$$$:
$$$$$$$class
$$$$$$$:
$$$$$$$`~flask.Response`
...
$$$$$$$data
$$$$$$$:
$$$$$$$`JSONIFY_PRETTYPRINT_REGULAR` is ``True``
$$$$$$$,
$$$$$$$
...
$$$$$$$ 0.11
        ...
        a security risk in ancient browsers. See 
$$$$$$$:
$$$$$$$ref
$$$$$$$:
$$$$$$$`security-json`.
