...
$$$$$$$ print it 
$$$$$$$(
$$$$$$$to simulate the user typing it
$$$$$$$)
$$$$$$$
$$$$$$$,
$$$$$$$ and then
...
$$$$$$$ $=$= a_trunc
    ...
    # in-place
$$$$$$$,
$$$$$$$ since that global is used directly by the stdlib's pdb module.
...
$$$$$$$
    ...
    First
$$$$$$$,
$$$$$$$ set up some test functions and classes which we can inspect.
...
$$$$$$$(
$$$$$$$this is implemented in ipykernel
$$$$$$$)
...
$$$$$$$)
$$$$$$$
        # The way this test will fail is by set_trace
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ never exiting
...
$$$$$$$,
$$$$$$$ but that adds issues with
        # interrupting subprocesses that are rather complex
$$$$$$$,
$$$$$$$ so it's simpler
...
$$$$$$$
$$$$$$$)
$$$$$$$ for b in skip_decorators_blocks]
    in_prompt_number $= 1
...
$$$$$$$
    ...
    ### we need a filename
$$$$$$$,
$$$$$$$ so we need to exec the full block with a filename
...
$$$$$$$x
$$$$$$$)
$$$$$$$ for x in skip_decorators_blocks[
$$$$$$$:
$$$$$$$-1]]
$$$$$$$)
$$$$$$$.encode
...
$$$$$$$
        ...
        # as the filename does not exists
$$$$$$$,
$$$$$$$ we'll rely on the filename prompt
        child.expect_exact
$$$$$$$(
$$$$$$$
$$$$$$$"
...
$$$$$$$ 
$$$$$$$"
$$$$$$$1---> 3     pass # should not stop here except
$$$$$$$"
$$$$$$$
$$$$$$$)
$$$$$$$
