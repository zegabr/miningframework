# Matplotlib documentation build configuration file
$$$$$$$,
$$$$$$$ created by
# sphinx-quickstart on Fri May  2 12
$$$$$$$:
$$$$$$$33
$$$$$$$:
$$$$$$$25 2008.
...
$$$$$$$
$$$$$$$)
$$$$$$$d with the current directory set to its containing
# dir.
#
# The contents of this file are pickled
$$$$$$$,
$$$$$$$ so don't put values in the namespace
# that aren't pickleable 
$$$$$$$(
$$$$$$$module imports are okay
$$$$$$$,
$$$$$$$ they're removed
# automatically
$$$$$$$)
...
# Parse year using SOURCE_DATE_EPOCH
$$$$$$$,
...
# If your extensions are in another directory
$$$$$$$,
$$$$$$$ add it here. If the directory
# is relative to the documentation root
$$$$$$$,
$$$$$$$ use os.path.abspath to make it
# absolute
$$$$$$$,
$$$$$$$ like shown here.
sys.path.append
...
# Unless we catch the warning explicitly somewhere
$$$$$$$,
$$$$$$$ a warning should cause the
...
$$$$$$$
$$$$$$$)
$$$$$$$ from emitting a non-GUI backend warning.
os.environ.pop
$$$$$$$(
$$$$$$$
$$$$$$$"
...
# autodoc purposes
$$$$$$$,
$$$$$$$ as this will disappear automatically when they are removed
warnings.filterwarnings
$$$$$$$(
$$$$$$$'ignore'
$$$$$$$,
...
$$$$$$$
                        module$='importlib'
$$$$$$$,
$$$$$$$  # used by sphinx.autodoc.importer
                        message$=r'
$$$$$$$(
$$$$$$$\n|.
$$$$$$$)
...
# missing-references names matches sphinx>$=3 behavior
$$$$$$$,
$$$$$$$ so we can't be nitpicky
# for older sphinxes.
nitpicky $= sphinx.version_info >$= 
$$$$$$$(
$$$$$$$3
$$$$$$$,
$$$$$$$
...
$$$$$$$'https
$$$$$$$:
$$$$$$$//ipykernel.readthedocs.io/en/latest/'
$$$$$$$,
$$$$$$$ None
$$$$$$$)
$$$$$$$
...
$$$$$$$
    'junit'
$$$$$$$:
$$$$$$$ '../test-results/sphinx-gallery/junit.xml' if CIRCLECI else ''
$$$$$$$,
$$$$$$$
}
...
$$$$$$$ pyplot
    ...
    <https
$$$$$$$:
$$$$$$$//sphinx-gallery.readthedocs.io>`_\n
$$$$$$$"
$$$$$$$
$$$$$$$"
$$$$$$$
...
$$$$$$$)
$$$$$$$
# Catch the case where git is not installed locally
$$$$$$$,
$$$$$$$ and use the setuptools_scm
...
# If true
$$$$$$$,
$$$$$$$ the current module name will be prepended to all description
# unit titles 
$$$$$$$(
$$$$$$$such as .. function
$$$$$$$:
...
# If true
$$$$$$$,
$$$$$$$ sectionauthor and moduleauthor directives will be shown in the
...
# must exist either in Sphinx' static/ path
$$$$$$$,
$$$$$$$ or in one of the custom paths
...
$$$$$$$,
$$$$$$$
    # collapse_navigation in pydata-sphinx-theme is slow
$$$$$$$,
$$$$$$$ so skipped for local
    # and CI builds https
$$$$$$$:
$$$$$$$//github.com/pydata/pydata-sphinx-theme/pull/386
...
# If true
$$$$$$$,
$$$$$$$ generate domain-specific indices in addition to the general index.
# For e.g. the Python domain
$$$$$$$,
$$$$$$$ this is the global module index.
html_domain_index $= False

# If true
$$$$$$$,
$$$$$$$ the reST sources are included in the HTML build as _sources/<name>.
# html_copy_source $= True

# If true
$$$$$$$,
$$$$$$$ an OpenSearch description file will be output
$$$$$$$,
$$$$$$$ and all pages will
...
$$$$$$$
     ...
     '\\and and the matplotlib development team'
$$$$$$$,
$$$$$$$ 'manual'
$$$$$$$)
$$$$$$$
...
# Keep babel usage also with xelatex 
$$$$$$$(
$$$$$$$Sphinx default is polyglossia
$$$$$$$)
$$$$$$$
# If this key is removed or changed
$$$$$$$,
$$$$$$$ latex build directory must be cleaned
latex_elements['babel'] $= r'\usepackage{babel}'

# Font configuration
# Fix fontspec converting 
$$$$$$$"
$$$$$$$ into right curly quotes in PDF
# cf https
$$$$$$$:
$$$$$$$//github.com/sphinx-doc/sphinx/pull/6888/
...
# Sphinx 2.0 adopts GNU FreeFont by default
$$$$$$$,
$$$$$$$ but it does not have all
...
# Sphinx <1.8.0 or >$=2.0.0 does this by default
$$$$$$$,
$$$$$$$ but the 1.8.x series
# did not for latex_engine $= 'xelatex' 
$$$$$$$(
$$$$$$$as it used Latin Modern font
$$$$$$$)
$$$$$$$.
...
$$$$$$$"
$$$$$$$
# Sphinx 1.5 provides this to avoid 
$$$$$$$"
$$$$$$$too deeply nested
$$$$$$$"
$$$$$$$ LaTeX error
...
# https
$$$$$$$:
$$$$$$$//github.com/sphinx-doc/sphinx/issues/3176
# graphviz_output_format $= 'svg'


def reduce_plot_formats
$$$$$$$(
$$$$$$$app
$$$$$$$)
$$$$$$$
$$$$$$$:
$$$$$$$
    # Fox CI and local builds
$$$$$$$,
$$$$$$$ we don't need all the default plot formats
$$$$$$$,
$$$$$$$ so
...
$$$$$$$https
$$$$$$$:
$$$$$$$//github.com/matplotlib/matplotlib/blob
$$$$$$$"
$$$$$$$
                f
$$$$$$$"
