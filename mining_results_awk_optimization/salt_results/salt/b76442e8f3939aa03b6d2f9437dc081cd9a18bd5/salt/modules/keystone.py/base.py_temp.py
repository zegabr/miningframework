...
$$$$$$$ admin
        keystone.tenant_id
$$$$$$$:
$$$$$$$ f80919baedab48ec8931f200c65a50df
        keystone.auth_url
$$$$$$$:
$$$$$$$ 'http
$$$$$$$:
...
$$$$$$$,
$$$$$$$ any of the keystone functions can make use
...
$$$$$$$"
$$$$$$$keystone execution module cannot be loaded
$$$$$$$:
$$$$$$$ keystoneclient python library not available.
$$$$$$$"
$$$$$$$
$$$$$$$,
$$$$$$$
...
$$$$$$$"
$$$$$$$
        look in connection_args first
$$$$$$$,
$$$$$$$ then default to config file
...
$$$$$$$ 
$$$$$$$"
$$$$$$$Could not resolve Tenant ID
$$$$$$$"
$$$$$$$}

    newec2 $= kstone.ec2.create
$$$$$$$(
$$$$$$$user_id
$$$$$$$,
$$$$$$$ tenant_id
...
$$$$$$$"
$$$$$$$
    Return ec2_credentials for a user 
$$$$$$$(
...
$$$$$$$"
$$$$$$$
    Return a list of ec2_credentials for a specific user 
$$$$$$$(
...
$$$$$$$"
$$$$$$$}
    for ec2_credential in kstone.ec2.list
$$$$$$$(
$$$$$$$user_id
$$$$$$$)
$$$$$$$
...
$$$$$$$interface
$$$$$$$"
$$$$$$$] $=$= interface if interface else True
$$$$$$$)
$$$$$$$
            else None
...
$$$$$$${0}
$$$$$$$)
$$$$$$$ for the {1} service. Please specify region.
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$
...
$$$$$$$ bash
        ...
        salt 'v2' keystone.endpoint_create nova 'http
$$$$$$$:
$$$$$$$//public/url' 'http
$$$$$$$:
$$$$$$$//internal/url' 'http
...
$$$$$$$//adminurl/url' region
        ...
        salt 'v3' keystone.endpoint_create nova url$='http
$$$$$$$:
$$$$$$$//public/url' interface$='public' region$='RegionOne'
...
$$$$$$$(
$$$$$$$
            service$=keystone_service[service][
$$$$$$$"
$$$$$$$id
$$$$$$$"
$$$$$$$]
...
$$$$$$$,
$$$$$$$
            service_id$=keystone_service[service][
$$$$$$$"
$$$$$$$id
$$$$$$$"
$$$$$$$]
...
$$$$$$$ 
$$$$$$$"
$$$$$$$Unable to resolve role id
$$$$$$$"
$$$$$$$}

    role $= kstone.roles.get
$$$$$$$(
$$$$$$$role_id
$$$$$$$)
$$$$$$$
...
$$$$$$$
    ...
    kstone.services.delete
$$$$$$$(
$$$$$$$service_id
$$$$$$$)
$$$$$$$
    return 'Keystone service ID 
$$$$$$$"
$$$$$$${0}
$$$$$$$"
$$$$$$$ deleted'.format
...
$$$$$$$ 
$$$$$$$"
$$$$$$$Unable to resolve service id
$$$$$$$"
$$$$$$$}
    service $= kstone.services.get
$$$$$$$(
$$$$$$$service_id
$$$$$$$)
$$$$$$$
...
$$$$$$$ 2016.11.0
    ...
    name
        The project name
$$$$$$$,
$$$$$$$ which must be unique within the owning domain.
...
$$$$$$$,
$$$$$$$ tenant.
    Because the name is one of the fields
$$$$$$$,
...
$$$$$$$
    ret $= 
$$$$$$$"
$$$$$$$Password updated for user ID {0}
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$user_id
...
$$$$$$$ 
$$$$$$$"
$$$$$$$Unable to resolve tenant/project id
$$$$$$$"
$$$$$$$}
...
$$$$$$$"
$$$$$$$
    Remove role for user in tenant 
$$$$$$$(
...
$$$$$$$"
$$$$$$$
    Return a list of available user_roles 
$$$$$$$(
...
$$$$$$$ 
$$$$$$$"
$$$$$$$Unable to resolve user or tenant/project id
$$$$$$$"
$$$$$$$}
...
$$$$$$$:
$$$$$$$
        for role in kstone.roles.roles_for_user
$$$$$$$(
$$$$$$$user$=user_id
$$$$$$$,
$$$$$$$ tenant$=tenant_id
