...
$$$$$$$
    ...
    versions of Python. If using version 6.0 of pyVmomi
$$$$$$$,
$$$$$$$ Python 2.7.9
$$$$$$$,
$$$$$$$
    ...
    version of Python is not in the supported range
$$$$$$$,
...
$$$$$$$ https
$$$$$$$:
$$$$$$$//github.com/saltstack/salt/issues/29537

Based on the note above
$$$$$$$,
$$$$$$$ to install an earlier version of pyVmomi than the
version currently listed in PyPi
$$$$$$$,
$$$$$$$ run the following
$$$$$$$:
$$$$$$$
...
$$$$$$$:
$$$$$$$//github.com/vmware/vsphere-automation-sdk-python.git
...
$$$$$$$
    ...
    In order to use the tagging functions in this module
$$$$$$$,
$$$$$$$ vSphere Automation SDK is necessary to
    install.
...
Currently
$$$$$$$,
$$$$$$$ about a third of the functions used in the vSphere Execution Module require
the ESXCLI package be installed on the machine running the Proxy Minion process.

The ESXCLI package is also referred to as the VMware vSphere CLI
$$$$$$$,
$$$$$$$ or vCLI. VMware
...
$$$$$$$ http
$$$$$$$:
$$$$$$$//pubs.vmware.com/vsphere-55/index.jsp#com.vmware.vcli.getstart.doc/cli_install.4.2.html
.. _vSphere 6.0
$$$$$$$:
$$$$$$$ http
$$$$$$$:
$$$$$$$//pubs.vmware.com/vsphere-60/index.jsp#com.vmware.vcli.getstart.doc/cli_install.4.2.html

Once all of the required dependencies are in place and the vCLI package is
installed
$$$$$$$,
$$$$$$$ you can check to see if you can connect to your ESXi host or vCenter
...
$$$$$$$,
$$$$$$$ ESXCLI was successfully installed on your system.
...
$$$$$$$
    ...
    type of license attached to a vCenter Server or ESXi host
$$$$$$$(
$$$$$$$s
$$$$$$$)
$$$$$$$.
    ...
    For example
$$$$$$$,
$$$$$$$ certain services are only available to manipulate service state
    or policies with a VMware vSphere Enterprise or Enterprise Plus license
$$$$$$$,
$$$$$$$ while
    others are available with a Standard license. The ``ntpd`` service is restricted
    to an Enterprise Plus license
$$$$$$$,
$$$$$$$ while ``ssh`` is available via the Standard
    license.
...
$$$$$$$ https
$$$$$$$:
$$$$$$$//www.vmware.com/products/vsphere/compare
...
vCenter Server
$$$$$$$,
$$$$$$$ as well as to an ESXi host. It utilizes the pyVmomi Python
...
$$$$$$$ ``username``
$$$$$$$,
$$$$$$$ and ``password``. If the credentials provided
apply to a vCenter Server
$$$$$$$,
$$$$$$$ then the function will be run against the vCenter
Server. For example
$$$$$$$,
$$$$$$$ when listing hosts using vCenter credentials
$$$$$$$,
$$$$$$$ you'll get a
...
However
$$$$$$$,
$$$$$$$ some functions should be used against ESXi hosts
$$$$$$$,
$$$$$$$ not vCenter Servers.
...
information you're using is against a vCenter server and not an ESXi host
$$$$$$$,
$$$$$$$ you
...
$$$$$$$ as a list
$$$$$$$,
$$$$$$$ using the ``host_names`` or ``esxi_host`` kwarg. For
example
$$$$$$$:
$$$$$$$
...
$$$$$$$ bash
    ...
    # salt my-minion vsphere.get_coredump_network_config <vcenter-ip> <vcenter-user> \
        <vcenter-password> esxi_hosts$='[esxi-1.example.com
$$$$$$$,
$$$$$$$ esxi-2.example.com]'
    my-minion
$$$$$$$:
...
connection to an ESXi host using the host's location
$$$$$$$,
$$$$$$$ username
$$$$$$$,
$$$$$$$ and password. If ESXi
connection credentials are used instead of vCenter credentials
$$$$$$$,
$$$$$$$ the ``host_names`` and
...
$$$$$$$"
$$$$$$$
    Returns the connection details of the following proxies
$$$$$$$:
$$$$$$$ esxi
...
def gets_service_instance_via_proxy
$$$$$$$(
$$$$$$$fn
$$$$$$$)
$$$$$$$
...
$$$$$$$"
$$$$$$$
    Decorator that connects to a target system 
$$$$$$$(
$$$$$$$vCenter or ESXi host
$$$$$$$)
$$$$$$$ using the
    proxy details and passes the connection 
$$$$$$$(
$$$$$$$vim.ServiceInstance
$$$$$$$)
$$$$$$$ to
...
$$$$$$$
        ...
        or a ``**kwarg`` type argument 
$$$$$$$(
$$$$$$$name of argument is not important
$$$$$$$)
$$$$$$$;
        2. If the ``service_instance`` parameter is already defined
$$$$$$$,
$$$$$$$ the value
        is passed through to the decorated function;
        3. If the ``service_instance`` parameter in not defined
$$$$$$$,
$$$$$$$ the
...
$$$$$$$)
$$$$$$$
    def _gets_service_instance_via_proxy
$$$$$$$(
$$$$$$$*args
$$$$$$$,
$$$$$$$ **kwargs
...
$$$$$$$service_instance
$$$$$$$"
$$$$$$$ not in arg_names and not kwargs_name
$$$$$$$:
$$$$$$$
            raise CommandExecutionError
$$$$$$$(
...
$$$$$$$"
$$$$$$$Function {} must have either a 'service_instance'
$$$$$$$,
$$$$$$$ or a 
$$$$$$$"
$$$$$$$
...
$$$$$$$
                ...
                # NOTE
$$$$$$$:
$$$$$$$ if 'service_instance' doesn't have a default value
...
$$$$$$$
                    # case 1
$$$$$$$:
$$$$$$$ The call was made with enough positional
...
$$$$$$$
                    # case 2
$$$$$$$:
$$$$$$$ Not enough positional parameters so
...
$$$$$$$)
$$$$$$$
def get_service_instance_via_proxy
$$$$$$$(
...
$$$$$$$:
$$$$$$$
        Should be used by state functions
$$$$$$$,
...
$$$$$$$ such as ``root``.
    ...
    cmd_str
        The ESXCLI command to run. Note
$$$$$$$:
$$$$$$$ This should not include the ``-s``
$$$$$$$,
$$$$$$$ ``-u``
$$$$$$$,
$$$$$$$
...
$$$$$$$ ``--protocol``
$$$$$$$,
$$$$$$$ or ``--portnumber`` arguments that are
    ...
    esxi_hosts
        If ``host`` is a vCenter host
$$$$$$$,
$$$$$$$ then use esxi_hosts to execute this function
...
$$$$$$$ bash
        ...
        salt '*' vsphere.esxcli_cmd my.vcenter.location root bad-password \
            'system coredump network get' esxi_hosts$='[esxi-1.host.com
$$$$$$$,
$$$$$$$ esxi-2.host.com]'
...
$$$$$$$return
$$$$$$$:
$$$$$$$ A dictionary with the network configuration
$$$$$$$,
$$$$$$$ or
$$$$$$$,
$$$$$$$ if getting
             the network config failed
$$$$$$$,
$$$$$$$ a an error message retrieved from the
             standard cmd.run_all dictionary
$$$$$$$,
$$$$$$$ per host.
...
$$$$$$$
            # format the response stdout into something useful
            stdout $= _format_coredump_stdout
$$$$$$$(
$$$$$$$response
$$$$$$$)
$$$$$$$
...
$$$$$$$
    ...
    and returns ``False`` if core dump is not enabled. If there was an error
$$$$$$$,
$$$$$$$ the error
...
$$$$$$$
    ...
    Note that ESXi requires that the dumps first be enabled 
$$$$$$$(
$$$$$$$see
    `coredump_network_enable`
$$$$$$$)
$$$$$$$ before these parameters may be set.
...
$$$$$$$return
$$$$$$$:
$$$$$$$ A standard cmd.run_all dictionary with a `success` key added
$$$$$$$,
$$$$$$$ per host.
             `success` will be True if the set succeeded
$$$$$$$,
$$$$$$$ False otherwise.
...
$$$$$$$
    cmd $= 
$$$$$$$"
$$$$$$$system coredump network set -v {} -i {} -o {}
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$
...
$$$$$$$return
$$$$$$$:
$$$$$$$ Nested dictionary with two toplevel keys ``rulesets`` and ``success``
...
$$$$$$$return
$$$$$$$:
$$$$$$$ A standard cmd.run_all dictionary
$$$$$$$,
$$$$$$$ per host.
...
$$$$$$$
    cmd $= 
$$$$$$$"
$$$$$$$network firewall ruleset set --enabled {} --ruleset-id$={}
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$
...
$$$$$$$"
$$$$$$$
    Set the specified syslog configuration parameter. By default
$$$$$$$,
$$$$$$$ this function will
...
$$$$$$$(
$$$$$$$corresponds to the command line switch for
...
$$$$$$$
        comma-separated
$$$$$$$,
$$$$$$$ but without spaces before or after commas.
...
$$$$$$$ https
$$$$$$$:
$$$$$$$//blogs.vmware.com/vsphere/2012/04/configuring-multiple-syslog-servers-for-esxi-5.html
$$$$$$$)
$$$$$$$
    ...
    reset_service
        After a successful parameter set
$$$$$$$,
$$$$$$$ reset the service. Defaults to ``True``.
...
$$$$$$$return
$$$$$$$:
$$$$$$$ Dictionary with a top-level key of 'success' which indicates
             if all the parameters were reset
$$$$$$$,
$$$$$$$ and individual keys
...
$$$$$$$
    ...
    # First
$$$$$$$,
$$$$$$$ enable the syslog firewall ruleset
$$$$$$$,
$$$$$$$ for each host
$$$$$$$,
$$$$$$$ if needed.
    if firewall and syslog_config $=$= 
$$$$$$$"
$$$$$$$loghost
$$$$$$$"
$$$$$$$
...
$$$$$$$
    ...
    # Set the config value on each esxi_host
$$$$$$$,
$$$$$$$ if provided.
    if esxi_hosts
$$$$$$$:
...
$$$$$$$
    ...
    ``syslog_config`` can be passed as a quoted
$$$$$$$,
...
$$$$$$$loghost'
        ...
        salt '*' vsphere.reset_syslog_config my.vcenter.location root bad-password \
            syslog_config$='logdir
$$$$$$$,
$$$$$$$loghost' esxi_hosts$='[esxi-1.host.com
$$$$$$$,
$$$$$$$ esxi-2.host.com]'
...
$$$$$$$"
$$$$$$$The 'reset_syslog_config' function requires a 
$$$$$$$"
$$$$$$$ 
$$$$$$$"
...
$$$$$$$
    ...
    cmd $= 
$$$$$$$"
$$$$$$$system syslog config set --reset$=
$$$$$$$"
$$$$$$$
    if 
$$$$$$$"
...
$$$$$$$:
$$$$$$$
        resets $= [ind_reset.strip
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ for ind_reset in syslog_config.split
$$$$$$$(
$$$$$$$
$$$$$$$"
$$$$$$$
...
$$$$$$$
    ...
    This function only works for ESXi
$$$$$$$,
$$$$$$$ not vCenter.
...
$$$$$$$param password
$$$$$$$:
$$$$$$$ Password for the ESXi web endpoint
...
$$$$$$$ Public SSH key
$$$$$$$,
$$$$$$$ will be added to authorized_keys on ESXi
    
$$$$$$$:
$$$$$$$param ssh_key_file
$$$$$$$:
$$$$$$$ File containing the SSH key.  Use 'ssh_key' or
                         ssh_key_file
$$$$$$$,
$$$$$$$ but not both.
...
$$$$$$$ defaults to https
$$$$$$$,
$$$$$$$ can be http if ssl is disabled on ESXi
...
$$$$$$$:
$$$$$$$ If true require that the SSL connection present
                               a valid certificate. Default
$$$$$$$:
$$$$$$$ True
...
$$$$$$$return
$$$$$$$:
$$$$$$$ Dictionary with a 'status' key
$$$$$$$,
$$$$$$$ True if upload is successful.
             If upload is unsuccessful
$$$$$$$,
$$$$$$$ 'status' key will be False and
...
$$$$$$$ such as ``root``.
    ...
    host_names
        List of ESXi host names. When the host
$$$$$$$,
$$$$$$$ username
$$$$$$$,
$$$$$$$ and password credentials
        are provided for a vCenter Server
$$$$$$$,
$$$$$$$ the host_names argument is required to tell
        vCenter the hosts for which to get date/time information.

        If host_names is not provided
$$$$$$$,
$$$$$$$ the date/time information will be retrieved for the
        ``host`` location instead. This is useful for when service instance connection
        information is used for a single ESXi host.

    verify_ssl
        Verify the SSL certificate. Default
$$$$$$$:
$$$$$$$ True
...
$$$$$$$)
$$$$$$$
        date_time_manager $= _get_date_time_mgr
$$$$$$$(
$$$$$$$host_ref
$$$$$$$)
$$$$$$$
...
$$$$$$$ the host_names argument is required to tell
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ the NTP configuration will be retrieved for the
        ``host`` location instead. This is useful for when service instance connection
        information is used for a single ESXi host.
...
$$$$$$$ the host_names argument is required to tell
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ the service policy information will be retrieved
...
$$$$$$$,
$$$$$$$ return. The service will be invalid for all hosts.
...
$$$$$$$
            msg $= 
$$$$$$$"
$$$$$$$'vsphere.get_service_policy' failed for host {}.
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$host_name
...
$$$$$$$ the host_names argument is required to tell
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ the service's running state will be retrieved
        for the ``host`` location instead. This is useful for when service instance
        connection information is used for a single ESXi host.
...
$$$$$$$
            msg $= 
$$$$$$$"
$$$$$$$'vsphere.get_service_running' failed for host {}.
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$host_name
...
$$$$$$$ and password credentials
        are provided for a vCenter Server
$$$$$$$,
$$$$$$$ the host_names argument is required to
        tell vCenter which hosts to check if VMotion is enabled.

        If host_names is not provided
$$$$$$$,
$$$$$$$ the VMotion status will be retrieved for the
...
$$$$$$$ ``False`` if it is not enabled
$$$$$$$,
$$$$$$$ and ``None`` if a VSAN Host Config
    is unset
$$$$$$$,
$$$$$$$ per host.
...
$$$$$$$ the host_names argument is required to
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ the VSAN status will be retrieved for the
        ``host`` location instead. This is useful for when service instance
        connection information is used for a single ESXi host.
...
$$$$$$$ the host_names argument is required to
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ the VSAN-eligible disks will be retrieved
        for the ``host`` location instead. This is useful for when service instance
        connection information is used for a single ESXi host.
...
$$$$$$$)
$$$$$$$
    response $= _get_vsan_eligible_disks
$$$$$$$(
$$$$$$$service_instance
$$$$$$$,
$$$$$$$ host
...
$$$$$$$)
$$$$$$$
        # If we have eligible disks
$$$$$$$,
$$$$$$$ it will be a list of disk objects
        if disks and isinstance
$$$$$$$(
$$$$$$$disks
$$$$$$$,
$$$$$$$ list
...
$$$$$$$
            disk_names $= []
            # We need to return ONLY the disk names
$$$$$$$,
$$$$$$$ otherwise
...
$$$$$$$:
$$$$$$$
        if salt.utils.vmware.is_connection_to_a_vcenter
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    ret $= salt.utils.vmware.get_inventory
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$.about.__dict__
...
$$$$$$$
                ret
$$$$$$$,
$$$$$$$ salt.utils.vmware.get_hardware_grains
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    return salt.utils.vmware.list_datacenters
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    return salt.utils.vmware.list_clusters
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    return salt.utils.vmware.list_datastore_clusters
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    return salt.utils.vmware.list_datastores
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    return salt.utils.vmware.list_hosts
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    return salt.utils.vmware.list_resourcepools
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    return salt.utils.vmware.list_networks
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    return salt.utils.vmware.list_vms
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    return salt.utils.vmware.list_folders
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    return salt.utils.vmware.list_dvs
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    return salt.utils.vmware.list_vapps
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$ the host_names argument is required to
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ SSDs will be retrieved for the
        ``host`` location instead. This is useful for when service instance
        connection information is used for a single ESXi host.
...
$$$$$$$
        ...
        In the pyVmomi StorageSystem
$$$$$$$,
$$$$$$$ ScsiDisks may
$$$$$$$,
$$$$$$$ or may not have an ``ssd`` attribute.
...
$$$$$$$ the host_names argument is required to
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ Non-SSD disks will be retrieved for the
        ``host`` location instead. This is useful for when service instance
        connection information is used for a single ESXi host.
...
$$$$$$$ the host_names argument is required to tell
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ the NTP servers will be configured for the
        ``host`` location instead. This is useful for when service instance connection
        information is used for a single ESXi host.
...
$$$$$$$ bash
        ...
        # Used for single ESXi host connection information
        salt '*' vsphere.ntp_configure my.esxi.host root bad-password '[192.174.1.100
$$$$$$$,
$$$$$$$ 192.174.1.200]'

        # Used for connecting to a vCenter Server
        salt '*' vsphere.ntp_configure my.vcenter.location root bad-password '[192.174.1.100
$$$$$$$,
$$$$$$$ 192.174.1.200]' \
        host_names$='[esxi-1.host.com
$$$$$$$,
...
$$$$$$$
    ...
    date_config $= vim.HostDateTimeConfig
$$$$$$$(
...
$$$$$$$"
$$$$$$$Configuring NTP Servers '{}' for host '{}'.
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$ntp_servers
...
$$$$$$$:
$$$$$$$
            date_time_manager.UpdateDateTimeConfig
$$$$$$$(
$$$$$$$config$=date_config
$$$$$$$)
$$$$$$$
...
$$$$$$$
            msg $= 
$$$$$$$"
$$$$$$$vsphere.ntp_configure_servers failed
$$$$$$$:
$$$$$$$ {}
$$$$$$$"
$$$$$$$.format
...
$$$$$$$ the host_names argument is required to tell
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ the service will be started for the ``host``
...
$$$$$$$
            msg $= 
$$$$$$$"
$$$$$$$'vsphere.service_start' failed for host {}
$$$$$$$:
$$$$$$$ {}
$$$$$$$"
$$$$$$$.format
...
$$$$$$$ the host_names argument is required to tell
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ the service will be stopped for the ``host``
        location instead. This is useful for when service instance connection information
        is used for a single ESXi host.
...
$$$$$$$
            msg $= 
$$$$$$$"
$$$$$$$'vsphere.service_stop' failed for host {}
$$$$$$$:
$$$$$$$ {}
$$$$$$$"
$$$$$$$.format
...
$$$$$$$ the host_names argument is required to tell
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ the service will be restarted for the ``host``
        location instead. This is useful for when service instance connection information
        is used for a single ESXi host.
...
$$$$$$$:
$$$$$$$
            service_manager.RestartService
$$$$$$$(
$$$$$$$id$=temp_service_name
$$$$$$$)
$$$$$$$
...
$$$$$$$
            msg $= 
$$$$$$$"
$$$$$$$'vsphere.service_restart' failed for host {}
$$$$$$$:
$$$$$$$ {}
$$$$$$$"
$$$$$$$.format
...
$$$$$$$
    ...
    service_policy
        The policy to set for the service. For example
$$$$$$$,
$$$$$$$ 'automatic'.
...
$$$$$$$
            ...
            # If we have a service_key
$$$$$$$,
$$$$$$$ we've found a match. Update the policy.
            if service_key
$$$$$$$:
$$$$$$$
                try
...
$$$$$$$
                    msg $= 
$$$$$$$"
$$$$$$$'vsphere.set_service_policy' failed for host {}
$$$$$$$:
$$$$$$$ {}
$$$$$$$"
$$$$$$$.format
...
$$$$$$$ the host_names argument is required to
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ the date/time will be updated for the ``host``
...
$$$$$$$
            msg $= 
$$$$$$$"
$$$$$$$'vsphere.update_date_time' failed for host {}
$$$$$$$:
$$$$$$$ {}
$$$$$$$"
$$$$$$$.format
...
$$$$$$$ Currently only works with connections to ESXi hosts. Does not work with vCenter servers.
    ...
    username
        The username used to login to the ESXi host
$$$$$$$,
$$$$$$$ such as ``root``.
...
$$$$$$$
    ...
    account_manager $= salt.utils.vmware.get_inventory
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$.accountManager
...
$$$$$$$ the host_names argument is required to
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ VMotion will be disabled for the ``host``
        location instead. This is useful for when service instance connection
        information is used for a single ESXi host.
...
$$$$$$$
            msg $= 
$$$$$$$"
$$$$$$$vsphere.vmotion_disable failed
$$$$$$$:
$$$$$$$ {}
$$$$$$$"
$$$$$$$.format
...
$$$$$$$ the host_names argument is required to
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ VMotion will be enabled for the ``host``
        location instead. This is useful for when service instance connection
        information is used for a single ESXi host.
...
$$$$$$$ the host_names argument is required to
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ VSAN-eligible disks will be added to the hosts's
...
$$$$$$$ disable$=broad-except
                    msg $= 
$$$$$$$"
$$$$$$$'vsphere.vsan_add_disks' failed for host {}
$$$$$$$:
$$$$$$$ {}
$$$$$$$"
$$$$$$$.format
...
$$$$$$$"
$$$$$$$Successfully added disks to the VSAN system for host '{}'.
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$
...
$$$$$$$
                # We need to return ONLY the disk names
$$$$$$$,
$$$$$$$ otherwise Message Pack can't deserialize the disk objects.
                disk_names $= []
...
$$$$$$$:
$$$$$$$
                # If we have a string type in the eligible value
$$$$$$$,
$$$$$$$ we don't
...
$$$$$$$
                # If we hit an error
$$$$$$$,
$$$$$$$ populate the Error return dict for state functions.
                ret.update
$$$$$$$(
$$$$$$${host_name
$$$$$$$:
...
$$$$$$$
                # If we made it this far
$$$$$$$,
$$$$$$$ we somehow have eligible disks
$$$$$$$,
$$$$$$$ but they didn't
...
$$$$$$$ the host_names argument is required to
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ VSAN will be disabled for the ``host``
        location instead. This is useful for when service instance connection
        information is used for a single ESXi host.
...
$$$$$$$
                ...
                task $= vsan_system.UpdateVsan_Task
$$$$$$$(
$$$$$$$vsan_config
$$$$$$$)
$$$$$$$
...
$$$$$$$ disable$=broad-except
                msg $= 
$$$$$$$"
$$$$$$$'vsphere.vsan_disable' failed for host {}
$$$$$$$:
$$$$$$$ {}
$$$$$$$"
$$$$$$$.format
...
$$$$$$$ the host_names argument is required to
        ...
        If host_names is not provided
$$$$$$$,
$$$$$$$ VSAN will be enabled for the ``host``
        location instead. This is useful for when service instance connection
        information is used for a single ESXi host.
...
$$$$$$$
                msg $= 
$$$$$$$"
$$$$$$$'vsphere.vsan_enable' failed for host {}
$$$$$$$:
$$$$$$$ {}
$$$$$$$"
$$$$$$$.format
...
$$$$$$$
$$$$$$$"
$$$$$$$Building the dict of the DVS '{}' config
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$dvs_name
...
$$$$$$$
$$$$$$$:
$$$$$$$ dvs_config.uplinkPortPolicy.uplinkPortName}
$$$$$$$)
$$$$$$$
    return conf_dict


def _get_dvs_link_discovery_protocol
$$$$$$$(
$$$$$$$dvs_name
$$$$$$$,
...
$$$$$$$"
$$$$$$$Building the dict of the DVS '{}' link discovery 
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$protocol
...
$$$$$$$
$$$$$$$:
$$$$$$$ dvs_link_disc_protocol.operation
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ dvs_link_disc_protocol.protocol
$$$$$$$,
$$$$$$$
    }


def _get_dvs_product_info
$$$$$$$(
$$$$$$$dvs_name
$$$$$$$,
$$$$$$$ dvs_product_info
...
$$$$$$$
$$$$$$$"
$$$$$$$Building the dict of the DVS '{}' product 
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$info
...
$$$$$$$
$$$$$$$:
$$$$$$$ dvs_product_info.version
$$$$$$$,
$$$$$$$
    }


def _get_dvs_capability
$$$$$$$(
$$$$$$$dvs_name
$$$$$$$,
$$$$$$$ dvs_capability
...
$$$$$$$
$$$$$$$"
$$$$$$$Building the dict of the DVS '{}' capability
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ dvs_capability.dvsOperationSupported
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ dvs_capability.dvPortOperationSupported
$$$$$$$,
$$$$$$$
    }


def _get_dvs_infrastructure_traffic_resources
$$$$$$$(
$$$$$$$dvs_name
$$$$$$$,
...
$$$$$$$
$$$$$$$:
$$$$$$$ res.allocationInfo.shares.shares
$$$$$$$,
$$$$$$$
...
$$$$$$$"
$$$$$$$
    Returns a list of distributed virtual switches 
$$$$$$$(
$$$$$$$DVSs
$$$$$$$)
$$$$$$$.
    ...
    dvs_names
        List of DVS names to look for. If None
$$$$$$$,
$$$$$$$ all DVSs are returned.
        Default value is None.
...
$$$$$$$ bash
        ...
        salt '*' vsphere.list_dvss dvs_names$=[dvs1
$$$$$$$,
$$$$$$$dvs2]
...
$$$$$$$
    ...
    for dvs in salt.utils.vmware.get_dvss
$$$$$$$(
$$$$$$$dc_ref
$$$$$$$,
$$$$$$$ dvs_names
...
$$$$$$$
        ...
        # XXX
$$$$$$$:
$$$$$$$ Because of how VMware did DVS object inheritance we can\'t
        # be more restrictive when retrieving the dvs config
$$$$$$$,
$$$$$$$ we have to
...
def _apply_dvs_link_discovery_protocol
$$$$$$$(
$$$$$$$disc_prot_config
$$$$$$$,
$$$$$$$ disc_prot_dict
...
$$$$$$$"
$$$$$$$
    disc_prot_config.operation $= disc_prot_dict[
$$$$$$$"
$$$$$$$operation
$$$$$$$"
$$$$$$$]
    disc_prot_config.protocol $= disc_prot_dict[
$$$$$$$"
$$$$$$$protocol
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
        product_info_spec.name $= product_info_dict[
$$$$$$$"
$$$$$$$name
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
        product_info_spec.vendor $= product_info_dict[
$$$$$$$"
$$$$$$$vendor
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
        product_info_spec.version $= product_info_dict[
$$$$$$$"
$$$$$$$version
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
        capability_spec.dvsOperationSupported $= capability_dict[
$$$$$$$"
$$$$$$$operation_supported
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
            infra_traffic_resources.append
$$$$$$$(
$$$$$$$traffic_res
$$$$$$$)
$$$$$$$
...
$$$$$$$
            ...
            traffic_res.allocationInfo.shares.shares $= res_dict[
$$$$$$$"
$$$$$$$num_shares
$$$$$$$"
$$$$$$$]
...
def _apply_dvs_network_resource_pools
$$$$$$$(
...
$$$$$$$:
$$$$$$$
        ress $= [r for r in network_resource_pools if r.key $=$= res_dict[
$$$$$$$"
$$$$$$$key
$$$$$$$"
$$$$$$$]]
...
$$$$$$$:
$$$$$$$
            res.allocationInfo.limit $= res_dict[
$$$$$$$"
$$$$$$$limit
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
            res.allocationInfo.shares.shares $= res_dict[
$$$$$$$"
$$$$$$$num_shares
$$$$$$$"
$$$$$$$]
            res.allocationInfo.shares.level $= vim.SharesLevel
$$$$$$$(
$$$$$$$res_dict[
$$$$$$$"
$$$$$$$share_level
...
$$$$$$$.
    ...
    Note
$$$$$$$:
$$$$$$$ The ``dvs_name`` param will override any name set in ``dvs_dict``.

    dvs_dict
        Dict representation of the new DVS 
$$$$$$$(
...
$$$$$$$:
$$$$$$$
        dvs_refs $= salt.utils.vmware.get_dvss
$$$$$$$(
$$$$$$$dc_ref
$$$$$$$,
$$$$$$$ dvs_names$=[dvs_name]
...
$$$$$$$"
$$$$$$$
    Updates a distributed virtual switch 
$$$$$$$(
$$$$$$$DVS
$$$$$$$)
$$$$$$$.
...
def _get_dvportgroup_out_shaping
$$$$$$$(
$$$$$$$pg_name
$$$$$$$,
...
$$$$$$$
$$$$$$$"
$$$$$$$Retrieving portgroup's '{}' out shaping 
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$config
...
$$$$$$$
$$$$$$$:
$$$$$$$ out_shaping_policy.averageBandwidth.value
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ out_shaping_policy.burstSize.value
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ out_shaping_policy.enabled.value
$$$$$$$,
$$$$$$$
...
def _get_dvportgroup_security_policy
$$$$$$$(
$$$$$$$pg_name
$$$$$$$,
$$$$$$$ pg_default_port_config
...
$$$$$$$
$$$$$$$"
$$$$$$$Retrieving portgroup's '{}' security policy 
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$config
...
$$$$$$$
$$$$$$$:
$$$$$$$ sec_policy.forgedTransmits.value
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ sec_policy.macChanges.value
$$$$$$$,
$$$$$$$
    }


def _get_dvportgroup_teaming
$$$$$$$(
$$$$$$$pg_name
$$$$$$$,
$$$$$$$ pg_default_port_config
...
$$$$$$$
$$$$$$$"
$$$$$$$Retrieving portgroup's '{}' teaming
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$config
...
$$$$$$$
$$$$$$$:
$$$$$$$ teaming_policy.notifySwitches.value
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ teaming_policy.reversePolicy.value
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ teaming_policy.rollingOrder.value
$$$$$$$,
$$$$$$$
    }
...
$$$$$$$
$$$$$$$:
$$$$$$$ failure_criteria.checkBeacon.value
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ failure_criteria.checkDuplex.value
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ failure_criteria.checkErrorPercent.value
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ failure_criteria.checkSpeed.value
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ failure_criteria.fullDuplex.value
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ failure_criteria.percentage.value
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ uplink_order.standbyUplinkPort
$$$$$$$,
$$$$$$$
                }
            }
...
$$$$$$$
@gets_service_instance_via_proxy
def list_dvportgroups
$$$$$$$(
$$$$$$$dvs$=None
$$$$$$$,
$$$$$$$ portgroup_names$=None
$$$$$$$,
$$$$$$$ service_instance$=None
$$$$$$$)
$$$$$$$
...
$$$$$$$
    ...
    portgroup_names
        List of portgroup names to look for. If None
$$$$$$$,
$$$$$$$ all portgroups are
        returned.
        Default value is None
...
$$$$$$$)
$$$$$$$
    uplink_pg_ref $= salt.utils.vmware.get_uplink_dvportgroup
$$$$$$$(
$$$$$$$dvs_refs[0]
$$$$$$$)
$$$$$$$
    return _get_dvportgroup_dict
$$$$$$$(
$$$$$$$uplink_pg_ref
$$$$$$$)
$$$$$$$
...
$$$$$$$
$$$$$$$"
$$$$$$$Building portgroup's '{}' out shaping 
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$policy
...
$$$$$$$)
$$$$$$$
        out_shaping.averageBandwidth.value $= out_shaping_conf[
$$$$$$$"
$$$$$$$average_bandwidth
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
        out_shaping.burstSize.value $= out_shaping_conf[
$$$$$$$"
$$$$$$$burst_size
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
        out_shaping.enabled.value $= out_shaping_conf[
$$$$$$$"
$$$$$$$enabled
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
        out_shaping.peakBandwidth.value $= out_shaping_conf[
$$$$$$$"
$$$$$$$peak_bandwidth
$$$$$$$"
$$$$$$$]
...
def _apply_dvportgroup_security_policy
$$$$$$$(
$$$$$$$pg_name
$$$$$$$,
$$$$$$$ sec_policy
...
$$$$$$$
$$$$$$$"
$$$$$$$Building portgroup's '{}' security policy 
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$pg_name
...
$$$$$$$)
$$$$$$$
        sec_policy.allowPromiscuous.value $= sec_policy_conf[
$$$$$$$"
$$$$$$$allow_promiscuous
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
        sec_policy.forgedTransmits.value $= sec_policy_conf[
$$$$$$$"
$$$$$$$forged_transmits
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
        sec_policy.macChanges.value $= sec_policy_conf[
$$$$$$$"
$$$$$$$mac_changes
$$$$$$$"
$$$$$$$]
...
def _apply_dvportgroup_teaming
$$$$$$$(
$$$$$$$pg_name
$$$$$$$,
$$$$$$$ teaming
...
$$$$$$$)
$$$$$$$
        teaming.notifySwitches.value $= teaming_conf[
$$$$$$$"
$$$$$$$notify_switches
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
        teaming.policy.value $= teaming_conf[
$$$$$$$"
$$$$$$$policy
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
        teaming.reversePolicy.value $= teaming_conf[
$$$$$$$"
$$$$$$$reverse_policy
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
        teaming.rollingOrder.value $= teaming_conf[
$$$$$$$"
$$$$$$$rolling_order
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
            teaming.failureCriteria.speed.value $= failure_criteria_conf[
$$$$$$$"
$$$$$$$speed
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
            teaming.uplinkPortOrder.activeUplinkPort $= teaming_conf[
$$$$$$$"
$$$$$$$port_order
$$$$$$$"
$$$$$$$][
...
$$$$$$$:
$$$$$$$
            teaming.uplinkPortOrder.standbyUplinkPort $= teaming_conf[
$$$$$$$"
$$$$$$$port_order
$$$$$$$"
$$$$$$$][
...
$$$$$$$)
$$$$$$$
        pg_spec.defaultPortConfig.vlan.vlanId $= pg_conf[
$$$$$$$"
$$$$$$$vlan_id
$$$$$$$"
$$$$$$$]
...
$$$$$$$
    ...
    Note
$$$$$$$:
$$$$$$$ The ``portgroup_name`` param will override any name already set
    in ``portgroup_dict``.
...
$$$$$$$)
$$$$$$$
    salt.utils.vmware.create_dvportgroup
$$$$$$$(
$$$$$$$dvs_refs[0]
$$$$$$$,
$$$$$$$ spec
...
$$$$$$$)
$$$$$$$
    salt.utils.vmware.update_dvportgroup
$$$$$$$(
$$$$$$$pg_refs[0]
$$$$$$$,
$$$$$$$ spec
...
$$$$$$$val
$$$$$$$,
$$$$$$$ pbm.capability.types.DiscreteSet
$$$$$$$)
$$$$$$$
$$$$$$$:
$$$$$$$
...
$$$$$$$
    ...
    policy_names
        Names of policies to list. If None
$$$$$$$,
...
$$$$$$$"
$$$$$$$
    profile_manager $= salt.utils.pbm.get_profile_manager
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$
    def_policies $= [
        p for p in policies if p.systemCreatedProfileType $=$= 
$$$$$$$"
$$$$$$$VsanDefaultProfile
$$$$$$$"
$$$$$$$
...
def _get_capability_definition_dict
$$$$$$$(
$$$$$$$cap_metadata
$$$$$$$)
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ cap_metadata.propertyMetadata[0].type.typeName
$$$$$$$,
$$$$$$$
    }
...
$$$$$$$)
$$$$$$$
        for c in salt.utils.pbm.get_capability_definitions
$$$$$$$(
$$$$$$$profile_manager
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
                subprofile_spec.forceProvision $= subprofile_dict[
$$$$$$$"
$$$$$$$force_provision
$$$$$$$"
$$$$$$$]
...
$$$$$$$"
$$$$$$$Listing the default storage policy of datastore '{}'
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$
...
$$$$$$$dc2
        ...
        salt '*' vsphere.list_datacenters_via_proxy datacenter_names$=[dc1
$$$$$$$,
$$$$$$$ dc2]
...
$$$$$$$"
$$$$$$$
    salt.utils.vmware.create_datacenter
$$$$$$$(
$$$$$$$service_instance
$$$$$$$,
$$$$$$$ datacenter_name
...
$$$$$$$"
$$$$$$$Building a dictionary representation of cluster 
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$'{}'
...
$$$$$$$"
$$$$$$$] $= ha_conf.admissionControlEnabled
...
$$$$$$$
$$$$$$$:
$$$$$$$ pol.cpuFailoverResourcesPercent
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ pol.memoryFailoverResourcesPercent
$$$$$$$,
$$$$$$$
        }
...
$$$$$$$
$$$$$$$:
$$$$$$$ o.value} for o in ha_conf.option
        ]
    res[
$$$$$$$"
$$$$$$$ha
...
$$$$$$$
    ...
    if salt.utils.vsan.vsan_supported
$$$$$$$(
$$$$$$$si
$$$$$$$)
$$$$$$$
$$$$$$$:
$$$$$$$
        # XXX The correct way of retrieving the VSAN data 
$$$$$$$(
$$$$$$$on the if branch
$$$$$$$)
$$$$$$$
        #  is not supported before 60u2 vcenter
        vcenter_info $= salt.utils.vmware.get_service_info
$$$$$$$(
$$$$$$$si
$$$$$$$)
$$$$$$$
...
$$$$$$$  # 60u2
            ...
            vsan_conf $= salt.utils.vsan.get_cluster_vsan_info
$$$$$$$(
$$$$$$$cluster_ref
$$$$$$$)
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ default_config.autoClaimStorage
$$$$$$$,
$$$$$$$
                }
    return res
...
$$$$$$$)
$$$$$$$
        cluster_ref $= salt.utils.vmware.get_cluster
$$$$$$$(
$$$$$$$dc_ref
$$$$$$$,
$$$$$$$ cluster
...
$$$$$$$:
$$$$$$$
            das_config.admissionControlEnabled $= ha_dict[
$$$$$$$"
$$$$$$$admission_control_enabled
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
            das_config.hBDatastoreCandidatePolicy $= ha_dict[
$$$$$$$"
$$$$$$$hb_ds_candidate_policy
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
            das_config.hostMonitoring $= ha_dict[
$$$$$$$"
$$$$$$$host_monitoring
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
                    das_config.option[-1].value $= opt_dict[
$$$$$$$"
$$$$$$$value
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
            das_config.vmMonitoring $= ha_dict[
$$$$$$$"
$$$$$$$vm_monitoring
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
            drs_config.vmotionRate $= 6 - drs_dict[
$$$$$$$"
$$$$$$$vmotion_rate
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
        cluster_spec.vmSwapPlacement $= cluster_dict[
$$$$$$$"
$$$$$$$vm_swap_placement
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
                vsan_spec.vsanClusterConfig.enabled $= vsan_dict[
$$$$$$$"
$$$$$$$enabled
$$$$$$$"
$$$$$$$]
...
$$$$$$$)
$$$$$$$
                vsan_spec.dataEfficiencyConfig.dedupEnabled $= vsan_dict[
$$$$$$$"
$$$$$$$dedup_enabled
$$$$$$$"
$$$$$$$]
...
$$$$$$$
            ...
            vsan_config.defaultConfig.autoClaimStorage $= vsan_dict[
$$$$$$$"
$$$$$$$auto_claim_storage
$$$$$$$"
$$$$$$$]
...
$$$$$$$
    ...
    Note
$$$$$$$:
$$$$$$$ cluster_dict['name'] will be overridden by the cluster param value
...
$$$$$$$
$$$$$$$)
$$$$$$$ and not salt.utils.vsan.vsan_supported
$$$$$$$(
$$$$$$$
        service_instance
...
$$$$$$$
$$$$$$$"
$$$$$$$VSAN operations are not supported
$$$$$$$"
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$  # 60u2
            vsan_spec $= vim.vsan.ReconfigSpec
$$$$$$$(
$$$$$$$modify$=True
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
            salt.utils.vsan.reconfigure_cluster_vsan
$$$$$$$(
$$$$$$$cluster_ref
$$$$$$$,
$$$$$$$ vsan_spec
...
$$$$$$$  # 60u2
            vsan_61 $= False
            vsan_info $= salt.utils.vsan.get_cluster_vsan_info
$$$$$$$(
$$$$$$$cluster_ref
$$$$$$$)
$$$$$$$
...
$$$$$$$"
$$$$$$$].vsanConfigInfo
        # We only need to configure the cluster_spec
$$$$$$$,
$$$$$$$ as if it were a vsan_61
        # cluster
        _apply_cluster_dict
$$$$$$$(
$$$$$$$cluster_spec
...
$$$$$$$canonical names
$$$$$$$)
$$$$$$$ or backing disk scsi addresses.
...
$$$$$$$ bash
        ...
        salt '*' vsphere.list_datastores_via_proxy datastore_names$=[ds1
$$$$$$$,
$$$$$$$ ds2]
...
$$$$$$$"
$$$$$$$
    target $= _get_proxy_target
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
    target_name $= salt.utils.vmware.get_managed_object_name
$$$$$$$(
$$$$$$$target
$$$$$$$)
$$$$$$$
...
$$$$$$$
        ...
        if not 
$$$$$$$(
$$$$$$$datastore_names or backing_disk_ids or backing_disk_scsi_addresses
$$$$$$$)
$$$$$$$
        else False
...
$$$$$$$
                target
$$$$$$$,
$$$$$$$ scsi_addresses$=backing_disk_scsi_addresses
...
$$$$$$$(
$$$$$$$
            backing_disk_ids.extend
$$$$$$$(
$$$$$$$disk_ids
$$$$$$$)
$$$$$$$ if backing_disk_ids else disk_ids
...
$$$$$$$
        ...
        for vol in [
            ...
            if i.volume.name $=$= ds.name and isinstance
$$$$$$$(
$$$$$$$i.volume
$$$$$$$,
$$$$$$$ vim.HostVmfsVolume
...
$$$$$$$canonical name
$$$$$$$)
$$$$$$$ on which the datastore is created.
...
$$$$$$$:
$$$$$$$
        disks $= salt.utils.vmware.get_disks
$$$$$$$(
$$$$$$$host_ref
$$$$$$$,
$$$$$$$ disk_ids$=[disk_id]
...
$$$$$$$"
$$$$$$$Multiple datastores '{}' were found
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$datastore
...
$$$$$$$)
$$$$$$$
    licenses $= salt.utils.vmware.get_licenses
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ l.labels[0].value if l.labels else None
$$$$$$$,
$$$$$$$
...
$$$$$$$
$$$$$$$:
$$$$$$$ l.total if l.total > 0 else sys.maxsize
$$$$$$$,
$$$$$$$
...
$$$$$$$)
$$$$$$$
        return salt.utils.vmware.get_cluster
$$$$$$$(
$$$$$$$dc_ref
$$$$$$$,
$$$$$$$ entity[
...
$$$$$$$
$$$$$$$"
$$$$$$$Listing assigned licenses of entity {}
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$
...
$$$$$$$ bash
        ...
        salt '*' vsphere.assign_license license_key$=00000
$$$$$$$:
$$$$$$$00000
            license name$=test entity$={type
$$$$$$$:
$$$$$$$cluster
$$$$$$$,
$$$$$$$datacenter
...
$$$$$$$)
$$$$$$$
    return [salt.utils.vmware.get_managed_object_name
$$$$$$$(
$$$$$$$h
$$$$$$$)
$$$$$$$ for h in hosts]
...
$$$$$$$ bash
        ...
        salt '*' vsphere.list_disks disk_ids$='[naa.00
$$$$$$$,
$$$$$$$ naa.001]'

        salt '*' vsphere.list_disks
            scsi_addresses$='[vmhba0
$$$$$$$:
$$$$$$$C0
$$$$$$$:
$$$$$$$T0
...
$$$$$$$
    # Default to getting all disks if no filtering is done
    get_all_disks $= True if not 
$$$$$$$(
$$$$$$$disk_ids or scsi_addresses
$$$$$$$)
$$$$$$$ else False
    ret_list $= []
...
$$$$$$$
    canonical_name_to_scsi_address $= {
        lun.canonicalName
$$$$$$$:
$$$$$$$ scsi_addr for scsi_addr
$$$$$$$,
$$$$$$$ lun in scsi_address_to_lun.items
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$
    ...
    The disk can be specified either by the canonical name
$$$$$$$,
$$$$$$$ or by the
    scsi_address.
...
$$$$$$$ bash
        ...
        salt '*' vsphere.erase_disk_partitions scsi_address$='vmhaba0
$$$$$$$:
$$$$$$$C0
$$$$$$$:
$$$$$$$T0
...
$$$$$$$"
$$$$$$$Either 'disk_id' or 'scsi_address' 
$$$$$$$"
$$$$$$$ 
$$$$$$$"
...
$$$$$$$"
$$$$$$$Erasing disk partitions on disk '{}' in host '{}'
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$
...
$$$$$$$"
$$$$$$$Erased disk partitions on disk '{}' on host '{}'
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$
...
$$$$$$$ bash
        ...
        salt '*' vsphere.list_disk_partitions scsi_address$='vmhaba0
$$$$$$$:
$$$$$$$C0
$$$$$$$:
$$$$$$$T0
...
$$$$$$$"
$$$$$$$Listing disk partitions on disk '{}' in host '{}'
$$$$$$$"
$$$$$$$ 
$$$$$$$"
$$$$$$$
...
$$$$$$$)
$$$$$$$
    partition_info $= salt.utils.vmware.get_disk_partition_info
$$$$$$$(
$$$$$$$host_ref
$$$$$$$,
$$$$$$$ disk_id
...
$$$$$$$
    ...
    # NOTE
$$$$$$$:
$$$$$$$ 1. The layout view has an extra 'None' partition for free space
...
$$$$$$$
$$$$$$$:
$$$$$$$ partition_info.spec.partitionFormat
$$$$$$$,
$$$$$$$
...
$$$$$$$
    ...
    canonical names. If no filtering is applied
$$$$$$$,
$$$$$$$ all disk groups are returned.
...
$$$$$$$
$$$$$$$:
$$$$$$$ [d.canonicalName for d in dg.nonSsd]
$$$$$$$,
$$$$$$$
            }
...
$$$$$$$ bash
        ...
        salt '*' vsphere.create_diskgroup cache_disk_id$='naa.000000000000001'
            capacity_disk_ids$='[naa.000000000000002
$$$$$$$,
$$$$$$$ naa.000000000000003]'
...
$$$$$$$"
$$$$$$$]
    hci $= salt.utils.vmware.get_host_cache
$$$$$$$(
$$$$$$$host_ref
$$$$$$$)
$$$$$$$
...
$$$$$$$
$$$$$$$"
$$$$$$$Host cache not configured on host '{}'
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$hostname
...
$$$$$$$] $= False
    ...
    # TODO Support multiple host cache info objects 
$$$$$$$(
...
$$$$$$$
$$$$$$$"
$$$$$$$Disabling the host cache is not supported
$$$$$$$"
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$
    ...
    an ESXi host. If it's an ESXi host
$$$$$$$,
$$$$$$$ returns a list of a single host_name.

    If a host reference isn't found
$$$$$$$,
$$$$$$$ we're trying to find a host object for a vCenter
    server. Raises a CommandExecutionError in this case
$$$$$$$,
$$$$$$$ as we need host references to
    check against.
...
$$$$$$$
    ...
    If host_name is provided
$$$$$$$,
$$$$$$$ that is the host_object that will be returned.
...
$$$$$$$"
$$$$$$$
    search_index $= salt.utils.vmware.get_inventory
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$.searchIndex
    ...
    # First
$$$$$$$,
$$$$$$$ try to find the host reference by DNS Name.
    if host_name
$$$$$$$:
$$$$$$$
        host_ref $= search_index.FindByDnsName
$$$$$$$(
$$$$$$$dnsName$=host_name
$$$$$$$,
$$$$$$$ vmSearch$=False
...
$$$$$$$
    ...
    # If we couldn't find the host by DNS Name
$$$$$$$,
$$$$$$$ then try the IP Address.
    if host_ref is None
$$$$$$$:
$$$$$$$
        host_ref $= search_index.FindByIp
$$$$$$$(
$$$$$$$ip$=host
$$$$$$$,
$$$$$$$ vmSearch$=False
...
$$$$$$$ {'Error'
$$$$$$$:
$$$$$$$ 'VSAN System Config Manager is unset ...'}
$$$$$$$,
$$$$$$$
              'host_2'
$$$$$$$:
$$$$$$$ {'Eligible'
$$$$$$$:
$$$$$$$ 'The host xxx does not have any VSAN eligible disks.'}
$$$$$$$,
$$$$$$$
              'host_3'
$$$$$$$:
...
$$$$$$$
        ...
        # Get VSAN System Config Manager
$$$$$$$,
$$$$$$$ if available.
        host_ref $= _get_host_ref
$$$$$$$(
...
$$$$$$$
            msg $= 
$$$$$$$"
$$$$$$$The host '{}' does not have any VSAN eligible disks.
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$
...
$$$$$$$ 
$$$$$$$"
$$$$$$$'{}' is not a valid config variable.
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$syslog_config
...
$$$$$$$
    ...
    https
$$$$$$$:
$$$$$$$//github.com/vmware/pyvmomi/blob/master/docs/vim/DistributedVirtualSwitch.rst
...
$$$$$$$
    https
$$$$$$$:
$$$$$$$//www.vmware.com/support/developer/converter-sdk/conv60_apireference/vim.DistributedVirtualSwitch.html
$$$$$$$)
$$$$$$$

    says to create the DVS
$$$$$$$,
...
$$$$$$$ and then add the
    ...
    However
$$$$$$$,
$$$$$$$ if the physical NIC is in use as the only link from the host
    to vSphere
$$$$$$$,
$$$$$$$ this will fail with an unhelpful 
$$$$$$$"
$$$$$$$busy
$$$$$$$"
$$$$$$$ error.
...
$$$$$$$ however
$$$$$$$,
$$$$$$$ a Powershell PowerCLI cmdlet called Add-VDSwitchPhysicalNetworkAdapter
    that does what we want.  I used Onyx 
$$$$$$$(
$$$$$$$https
$$$$$$$:
...
$$$$$$$>
    ...
    The SOAP API maps closely to PyVmomi
$$$$$$$,
...
$$$$$$$)
$$$$$$$
    dvs $= salt.utils.vmware._get_dvs
$$$$$$$(
$$$$$$$service_instance
$$$$$$$,
$$$$$$$ dvs_name
...
$$$$$$$"
$$$$$$$No Distributed Virtual Switch found with name {}
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$dvs_name
...
$$$$$$$] $= False
    ...
    target_portgroup $= salt.utils.vmware._get_dvs_portgroup
$$$$$$$(
$$$$$$$dvs
$$$$$$$,
$$$$$$$ target_portgroup_name
...
$$$$$$$"
$$$$$$$No target portgroup found with name {}
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$target_portgroup_name
...
$$$$$$$"
$$$$$$$No uplink portgroup found with name {}
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$uplink_portgroup_name
...
$$$$$$$)
$$$$$$$
        p_nics $= salt.utils.vmware._get_pnics
$$$$$$$(
$$$$$$$host_ref
$$$$$$$)
$$$$$$$
...
$$$$$$$] $= False
        ...
        v_nics $= salt.utils.vmware._get_vnics
$$$$$$$(
$$$$$$$host_ref
$$$$$$$)
$$$$$$$
...
$$$$$$$] $= False
        ...
        v_nic_mgr $= salt.utils.vmware._get_vnic_manager
$$$$$$$(
$$$$$$$host_ref
$$$$$$$)
$$$$$$$
...
$$$$$$$ 
$$$$$$$"
$$$$$$$Unable to get the host's virtual nic manager.
$$$$$$$"
$$$$$$$}
...
$$$$$$$(
$$$$$$$
                    host_name in e.message.msg and 
$$$$$$$"
$$$$$$$already exists
$$$$$$$"
$$$$$$$ in e.message.msg
...
$$$$$$$ 
$$$$$$$"
$$$$$$$No matching portgroup on the vSwitch
$$$$$$$"
$$$$$$$}
$$$$$$$)
$$$$$$$
...
$$$$$$$,
$$$$$$$
            spec$=vim.HostVirtualSwitchSpec
$$$$$$$(
$$$$$$$numPorts$=current_vswitch_ports
$$$$$$$)
$$$$$$$
$$$$$$$,
$$$$$$$
...
$$$$$$$,
$$$$$$$
            spec$=vim.HostProxySwitchSpec
$$$$$$$(
$$$$$$$backing$=pnic_backing
$$$$$$$)
$$$$$$$
$$$$$$$,
$$$$$$$
...
$$$$$$$)
$$$$$$$
    if not salt.utils.vmware.is_connection_to_a_vcenter
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$"
$$$$$$$'_get_proxy_target' not supported 
$$$$$$$"
$$$$$$$ 
$$$$$$$"
...
$$$$$$$)
$$$$$$$
        reference $= salt.utils.vmware.get_cluster
$$$$$$$(
$$$$$$$dc_ref
$$$$$$$,
$$$$$$$ cluster
...
$$$$$$$
        ...
        reference $= salt.utils.vmware.get_datacenter
$$$$$$$(
$$$$$$$service_instance
$$$$$$$,
$$$$$$$ datacenter
...
$$$$$$$
        ...
        reference $= salt.utils.vmware.get_root_folder
$$$$$$$(
$$$$$$$service_instance
$$$$$$$)
$$$$$$$
...
$$$$$$$"
$$$$$$$Proxies connected directly to ESXi 
$$$$$$$"
$$$$$$$ 
$$$$$$$"
...
$$$$$$$)
$$$$$$$
        scheduled_hardware_upgrade.upgradePolicy $= 
$$$$$$$"
$$$$$$$always
$$$$$$$"
$$$$$$$
...
$$$$$$$:
$$$$$$$
        config_spec.numCoresPerSocket $= int
$$$$$$$(
$$$$$$$cpu_props[
$$$$$$$"
$$$$$$$cores_per_socket
...
$$$$$$$:
$$$$$$$
        config_spec.nestedHVEnabled $= cpu_props[
$$$$$$$"
$$$$$$$nested
$$$$$$$"
$$$$$$$]  # True
...
$$$$$$$:
$$$$$$$
        config_spec.cpuHotAddEnabled $= cpu_props[
$$$$$$$"
$$$$$$$hotadd
$$$$$$$"
$$$$$$$]  # True
...
$$$$$$$:
$$$$$$$
        config_spec.cpuHotRemoveEnabled $= cpu_props[
$$$$$$$"
$$$$$$$hotremove
$$$$$$$"
$$$$$$$]  # True
...
$$$$$$$:
$$$$$$$
        config_spec.memoryReservationLockedToMax $= memory[
$$$$$$$"
$$$$$$$reservation_max
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
        config_spec.memoryHotAddEnabled $= memory[
$$$$$$$"
$$$$$$$hotadd
$$$$$$$"
$$$$$$$]
...
$$$$$$$
    for key
$$$$$$$,
$$$$$$$ value in advanced_config.items
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
                if option.key $=$= key and option.value $=$= str
$$$$$$$(
$$$$$$$value
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    datacenter_ref $= salt.utils.vmware.get_datacenter
$$$$$$$(
$$$$$$$service_instance
$$$$$$$,
$$$$$$$ datacenter
...
$$$$$$$
    ...
    scsi_ctrls
        List of SCSI Controller objects 
$$$$$$$(
$$$$$$$old+newly created
$$$$$$$)
$$$$$$$
...
$$$$$$$"
$$$$$$$
    # list of new/old VirtualSCSIController objects
$$$$$$$,
$$$$$$$ both new and old objects
...
$$$$$$$"
$$$$$$$SCSI controller number {} doesn't exist
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$bus_number
...
$$$$$$$:
$$$$$$$
        convert_size $= salt.utils.vmware.convert_to_kb
$$$$$$$(
$$$$$$$unit
$$$$$$$,
$$$$$$$ size
$$$$$$$)
$$$$$$$
        disk_spec.device.capacityInKB $= convert_size[
$$$$$$$"
$$$$$$$size
$$$$$$$"
$$$$$$$]
...
$$$$$$$
    ...
    if eagerly_scrub is not None and eagerly_scrub !$= 
$$$$$$$"
$$$$$$$None
$$$$$$$"
$$$$$$$
...
$$$$$$$:
$$$$$$$
        # random negative integer for creations
$$$$$$$,
$$$$$$$ concrete device key
        # for updates
...
$$$$$$$
        ...
        network_spec.device.addressType $= 
$$$$$$$"
$$$$$$$Manual
$$$$$$$"
$$$$$$$
...
$$$$$$$)
$$$$$$$
        network_spec.device.connectable.startConnected $= connectable[
$$$$$$$"
$$$$$$$start_connected
$$$$$$$"
$$$$$$$]
...
$$$$$$$ 'SCSI controller 0'
          type
$$$$$$$:
$$$$$$$ paravirtual or lsilogic or lsilogic_sas
          bus_sharing
$$$$$$$:
$$$$$$$ 'no_sharing' or 'virtual_sharing' or 'physical_sharing'
...
$$$$$$$adapter
$$$$$$$"
$$$$$$$] for ide in ide_controllers]
        log.trace
$$$$$$$(
$$$$$$$
$$$$$$$"
$$$$$$$Creating IDE controllers {}
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$devs
...
def _apply_ide_controller_config
$$$$$$$(
...
$$$$$$$adapter
$$$$$$$"
$$$$$$$] for sata in sata_controllers]
        log.trace
$$$$$$$(
$$$$$$$
$$$$$$$"
$$$$$$$Creating SATA controllers {}
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$devs
...
def _apply_sata_controller_config
$$$$$$$(
...
$$$$$$$
            device_type
$$$$$$$:
$$$$$$$ datastore_iso_file or client_device
            client_device
$$$$$$$:
$$$$$$$
              mode
$$$$$$$:
$$$$$$$ atapi or passthrough
            datastore_iso_file
$$$$$$$:
$$$$$$$
              path
...
$$$$$$$)
$$$$$$$
        drive_spec.device.backing.fileName $= datastore_iso_file[
$$$$$$$"
$$$$$$$path
$$$$$$$"
$$$$$$$]
        datastore $= datastore_iso_file[
$$$$$$$"
$$$$$$$path
$$$$$$$"
$$$$$$$].partition
...
$$$$$$$:
$$$$$$$
        drive_spec.device.connectable.startConnected $= connectable[
$$$$$$$"
$$$$$$$start_connected
$$$$$$$"
$$$$$$$]
...
def _set_network_adapter_mapping
$$$$$$$(
$$$$$$$domain
$$$$$$$,
$$$$$$$ gateway
...
$$$$$$$)
$$$$$$$
        type_backing.proxyURI $= serial_device_spec[
$$$$$$$"
$$$$$$$backing
$$$$$$$"
$$$$$$$][
...
$$$$$$$"
$$$$$$$]
        type_backing.direction $= serial_device_spec[
$$$$$$$"
$$$$$$$backing
$$$$$$$"
$$$$$$$][
...
$$$$$$$"
$$$$$$$]
        type_backing.serviceURI $= serial_device_spec[
$$$$$$$"
$$$$$$$backing
$$$$$$$"
$$$$$$$][
...
$$$$$$$)
$$$$$$$
    connect_info.allowGuestControl $= serial_device_spec[
$$$$$$$"
$$$$$$$connectable
$$$$$$$"
$$$$$$$][
...
$$$$$$$
    ...
    connect_info.startConnected $= serial_device_spec[
$$$$$$$"
$$$$$$$connectable
$$$$$$$"
$$$$$$$][
...
$$$$$$$]
    ...
    device_spec.device.yieldOnPoll $= serial_device_spec[
$$$$$$$"
$$$$$$$yield
$$$$$$$"
$$$$$$$]
...
$$$$$$$
        ...
        # we need the randomly assigned 
$$$$$$$(
$$$$$$$temporary
$$$$$$$)
$$$$$$$ key of the newly created
        # SCSI controller
...
$$$$$$$ datastore
        if 
$$$$$$$(
$$$$$$$not filename and datastore
$$$$$$$)
$$$$$$$ or 
$$$$$$$(
$$$$$$$filename and not datastore
$$$$$$$)
$$$$$$$
$$$$$$$:
$$$$$$$
...
$$$$$$$)
$$$$$$$
        # unitNumber for disk attachment
$$$$$$$,
$$$$$$$ 0
$$$$$$$:
$$$$$$$0 1st 0 is the controller busNumber
$$$$$$$,
$$$$$$$
...
$$$$$$$adapter
$$$$$$$"
$$$$$$$] for inter in network_interfaces]
        log.trace
$$$$$$$(
$$$$$$$
$$$$$$$"
...
$$$$$$$,
$$$$$$$
                network_adapter_label$=interface[
$$$$$$$"
$$$$$$$adapter
$$$$$$$"
$$$$$$$]
...
$$$$$$$:
$$$$$$$
            serial_port_device $= _apply_serial_port
$$$$$$$(
$$$$$$$port
$$$$$$$,
$$$$$$$ key
...
$$$$$$$adapter
$$$$$$$"
$$$$$$$] for dvd in cd_drives]
        log.trace
$$$$$$$(
$$$$$$$
$$$$$$$"
$$$$$$$Creating cd/dvd drives {}
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$devs
...
$$$$$$$
            ...
            #  one which is available by default
$$$$$$$,
$$$$$$$ this is 'IDE 0'
            controller_key $= 200
            if controllers
...
$$$$$$$"
$$$$$$$
    Returns the device with the given key
$$$$$$$,
$$$$$$$ raises error if the device is
    not found.
...
$$$$$$$"
$$$$$$$
    Returns the device with the given label
$$$$$$$,
$$$$$$$ raises error if the device is
    not found.
...
$$$$$$$(
$$$$$$$
                    salt.utils.vmware.convert_to_kb
$$$$$$$(
$$$$$$$device[
$$$$$$$"
$$$$$$$unit
...
$$$$$$$"
$$$$$$$
    Compares virtual machine current and new configuration
$$$$$$$,
$$$$$$$ the current is the
    one which is deployed now
$$$$$$$,
$$$$$$$ and the new is the target config. Returns the
    differences between the objects in a dictionary
$$$$$$$,
$$$$$$$ the keys are the
    configuration parameter keys and the values are differences objects
$$$$$$$:
$$$$$$$ either
...
$$$$$$$
    ...
    # These values identify the virtual machine
$$$$$$$,
...
$$$$$$$
                {property_key
$$$$$$$:
$$$$$$$ current_config[property_key]}
$$$$$$$,
$$$$$$$
                {property_key
$$$$$$$:
$$$$$$$ new_config[property_key]}
$$$$$$$,
$$$$$$$
...
$$$$$$$
        ...
        # If the disk already exist
$$$$$$$,
$$$$$$$ the backing properties like eagerly scrub
        # and thin provisioning
        # cannot be updated
$$$$$$$,
$$$$$$$ and should not be identified as differences
        disk_diffs.remove_diff
$$$$$$$(
$$$$$$$diff_key$=
$$$$$$$"
$$$$$$$eagerly_scrub
...
$$$$$$$)
$$$$$$$
        # Filename updates are not supported yet
$$$$$$$,
$$$$$$$ on VSAN datastores the
...
$$$$$$$,
$$$$$$$ like 'object' which will include the
    vim.vm.device.VirtualDevice
$$$$$$$,
$$$$$$$ this is necessary for deletion and update
    actions.
...
$$$$$$$"
$$$$$$$] $= {}
    for extra_conf in virtual_machine[
$$$$$$$"
$$$$$$$config.extraConfig
$$$$$$$"
$$$$$$$]
...
$$$$$$$advanced_configs
$$$$$$$"
$$$$$$$][extra_conf.key] $= extra_conf.value
...
$$$$$$$
                # int list
$$$$$$$,
$$$$$$$ stores the keys of the disks which are attached
                # to this controller
                controller[
$$$$$$$"
$$$$$$$device
...
$$$$$$$"
$$$$$$$
            ] $= salt.utils.vmware.get_network_adapter_object_type
$$$$$$$(
$$$$$$$device
$$$$$$$)
$$$$$$$
...
$$$$$$$device
$$$$$$$"
$$$$$$$] $= device.device  # keys of the connected devices
                sata[
$$$$$$$"
$$$$$$$key
$$$$$$$"
...
$$$$$$$
    ...
    The controller property cannot be updated
$$$$$$$,
$$$$$$$ because controller address
    identifies the disk by the unit and bus number properties.

    disks_diffs
        List of old and new disk properties
$$$$$$$,
$$$$$$$ the properties are dictionary
        objects
...
$$$$$$$
                ...
                # reconfigure
                device_config_spec.device.backing $= current_disk[
$$$$$$$"
$$$$$$$object
$$$$$$$"
$$$$$$$].backing
...
$$$$$$$adapter
$$$$$$$"
$$$$$$$] for scsi in scsis_old_new]
        log.trace
$$$$$$$(
$$$$$$$
$$$$$$$"
$$$$$$$Updating SCSI controllers {}
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$devs
...
$$$$$$$
                ...
                # controller
$$$$$$$,
$$$$$$$ create a new one with the properties and then
                # attach the disk object to the newly created controller
$$$$$$$,
$$$$$$$ even
...
$$$$$$$s
$$$$$$$)
$$$$$$$ for changed network adapters
$$$$$$$,
$$$$$$$ the adapter type cannot
    be changed
$$$$$$$,
...
$$$$$$$mac
$$$$$$$"
$$$$$$$] for inter in interface_old_new]
        log.trace
$$$$$$$(
$$$$$$$
$$$$$$$"
...
$$$$$$$adapter
$$$$$$$"
$$$$$$$] for drive in drives_old_new]
        log.trace
$$$$$$$(
$$$$$$$
$$$$$$$"
$$$$$$$Updating cd/dvd drives {}
$$$$$$$"
$$$$$$$.format
$$$$$$$(
$$$$$$$devs
...
$$$$$$$
$$$$$$$"
$$$$$$$Cannot set verify_ssl to False and ca_bundle together
$$$$$$$"
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$
    ...
    The tag needs to meet the cardinality 
$$$$$$$(
...
$$$$$$$ and
    associability 
$$$$$$$(
$$$$$$$`CategoryModel.associable_types`
$$$$$$$)
...
$$$$$$$
    ...
    this method
$$$$$$$,
$$$$$$$ you need the attach tag privilege on the tag and the read
...
$$$$$$$InventoryServiceTag
$$$$$$$:
$$$$$$$b55ecc77-f4a5-49f8-ab52-38865467cfbe
$$$$$$$:
$$$$$$$GLOBAL
...
$$$$$$$
        ...
        # Note
$$$$$$$,
$$$$$$$ here the default is ClusterComputeResource
$$$$$$$,
$$$$$$$ which
...
$$$$$$$:
$$$$$$$
        Name of tag category to create 
$$$$$$$(
$$$$$$$ex. Machine
$$$$$$$,
$$$$$$$ OS
...
$$$$$$$:
$$$$$$$
            category_created $= client.tagging.Category.create
$$$$$$$(
$$$$$$$create_spec
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
            category_deleted $= client.tagging.Category.delete
$$$$$$$(
$$$$$$$category_id
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
            tag_created $= client.tagging.Tag.create
$$$$$$$(
$$$$$$$create_spec
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
            tag_deleted $= client.tagging.Tag.delete
$$$$$$$(
$$$$$$$tag_id
$$$$$$$)
$$$$$$$
...
$$$$$$$ bash
        ...
        salt vm_minion vsphere.create_vm vm_name$=vmname cpu$='{count
$$$$$$$:
$$$$$$$ 2
$$$$$$$,
$$$$$$$ nested
...
$$$$$$$ True}' ...
    ...
    datacenter
        Datacenter where the virtual machine will be deployed 
$$$$$$$(
$$$$$$$mandatory
$$$$$$$)
$$$$$$$
...
$$$$$$$,
$$$$$$$ set the container reference to start search
    # from it instead
    container_object $= salt.utils.vmware.get_datacenter
$$$$$$$(
$$$$$$$service_instance
$$$$$$$,
$$$$$$$ datacenter
...
$$$$$$$ placement_object
$$$$$$$)
$$$$$$$ $= salt.utils.vmware.get_placement
$$$$$$$(
$$$$$$$
        service_instance
$$$$$$$,
...
$$$$$$$
    ...
    # For VSAN disks we need to specify a different vm path name
$$$$$$$,
$$$$$$$ the vm file
...
$$$$$$$:
$$$$$$$
        scsi_specs $= _create_scsi_devices
$$$$$$$(
$$$$$$$scsi_devices
$$$$$$$)
$$$$$$$
        config_spec.deviceChange.extend
$$$$$$$(
$$$$$$$scsi_specs
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
        serial_port_specs $= _create_serial_ports
$$$$$$$(
$$$$$$$serial_ports
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
        ide_specs $= _create_ide_controllers
$$$$$$$(
$$$$$$$ide_controllers
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
        sata_specs $= _create_sata_controllers
$$$$$$$(
$$$$$$$sata_controllers
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
        new_scsi_devices $= _create_scsi_devices
$$$$$$$(
$$$$$$$diffs[
$$$$$$$"
$$$$$$$scsi_devices
...
$$$$$$$
        ...
        scsi_controllers $= [dev[
$$$$$$$"
$$$$$$$object
$$$$$$$"
$$$$$$$] for dev in current_config[
$$$$$$$"
$$$$$$$scsi_devices
$$$$$$$"
$$$$$$$]]
...
$$$$$$$:
$$$$$$$
        # SATA controllers don't have many properties
$$$$$$$,
...
$$$$$$$]]
        controllers.extend
$$$$$$$(
$$$$$$$[device_spec.device for device_spec in new_controllers]
$$$$$$$)
$$$$$$$
        cd_changes.extend
$$$$$$$(
...
$$$$$$$:
$$$$$$$
        # We can't display object
$$$$$$$,
$$$$$$$ although we will need them for delete
        # and update actions
$$$$$$$,
$$$$$$$ we will need to delete these before we summarize
        # the changes for the users
        if isinstance
$$$$$$$(
$$$$$$$properties
$$$$$$$,
$$$$$$$ salt.utils.listdiffer.ListDictDiffer
$$$$$$$)
$$$$$$$
$$$$$$$:
$$$$$$$
            properties.remove_diff
$$$$$$$(
$$$$$$$diff_key$=
$$$$$$$"
$$$$$$$object
...
$$$$$$$
    ...
    placement
        Placement dictionary of the virtual machine
$$$$$$$,
$$$$$$$ host or cluster
...
$$$$$$$,
$$$$$$$ datastore name should be included
...
$$$$$$$ 
$$$$$$$"
$$$$$$$Virtual machine registration action succeeded
$$$$$$$"
$$$$$$$
$$$$$$$,
$$$$$$$
...
$$$$$$$ 
$$$$$$$"
$$$$$$$Virtual machine is already powered on
$$$$$$$"
$$$$$$$
$$$$$$$,
$$$$$$$
...
$$$$$$$ 
$$$$$$$"
$$$$$$$Virtual machine power on action succeeded
$$$$$$$"
$$$$$$$
$$$$$$$,
$$$$$$$
...
$$$$$$$ 
$$$$$$$"
$$$$$$$Virtual machine power off action succeeded
$$$$$$$"
$$$$$$$
$$$$$$$,
$$$$$$$
...
$$$$$$$)
$$$$$$$
    salt.utils.vmware.unregister_vm
$$$$$$$(
$$$$$$$vm_ref
$$$$$$$)
$$$$$$$
