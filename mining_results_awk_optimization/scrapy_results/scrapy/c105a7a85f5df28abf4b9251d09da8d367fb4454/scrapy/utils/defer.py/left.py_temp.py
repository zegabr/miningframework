...
$$$$$$$Same as twisted.internet.defer.fail but delay calling errback until
    ...
    before attending pending delayed calls
$$$$$$$,
...
$$$$$$$
$$$$$$$"
$$$$$$$Same as twisted.internet.defer.maybeDeferred
$$$$$$$,
$$$$$$$ but delay calling
...
$$$$$$$
    # FIXME
$$$$$$$:
$$$$$$$ Hack to avoid introspecting tracebacks. This to speed up
    # processing of IgnoreRequest errors which are
$$$$$$$,
$$$$$$$ by far
$$$$$$$,
$$$$$$$ the most common
...
$$$$$$$ A class that wraps an async iterable into a normal iterator suitable
    for using in Cooperator.coiterate
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$. As it's only needed for parallel_async
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
$$$$$$$,
$$$$$$$
    it calls the callable directly in the callback
$$$$$$$,
$$$$$$$ instead of providing a more
    ...
    On the outside
$$$$$$$,
$$$$$$$ this class behaves as an iterator that yields Deferreds.
...
$$$$$$$ as expected.
    ...
    Cooperator calls __next__
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ multiple times and waits on the Deferreds
    returned from it. As async generators 
$$$$$$$(
$$$$$$$since Python 3.8
$$$$$$$)
$$$$$$$ don't support
    awaiting on __anext__
$$$$$$$(
$$$$$$$
$$$$$$$)
...
$$$$$$$ we need to serialize
    this. It's done by storing the Deferreds returned from __next__
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ and
    firing the oldest one when a result from __anext__
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ is available.
...
$$$$$$$ stores it
    ...
    for self.aiterator.__anext__
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ and puts it into self.anext_deferred.
    2. If __next__
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ is called again before self.anext_deferred fires
$$$$$$$,
$$$$$$$ more Deferreds
    are added to self.waiting_deferreds.
    3. When self.anext_deferred fires
$$$$$$$,
$$$$$$$ it either calls _callback
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ or _errback
...
$$$$$$$
$$$$$$$)
$$$$$$$ calls the callable passing the result value that it takes
$$$$$$$,
$$$$$$$ pops a
    Deferred from self.waiting_deferreds
$$$$$$$,
$$$$$$$ and if the callable result was a Deferred
$$$$$$$,
$$$$$$$ it
    chains those Deferreds so that the waiting Deferred will fire when the result
    Deferred does
$$$$$$$,
$$$$$$$ otherwise it fires it directly. This causes one awaiting task to
    receive a result. If self.waiting_deferreds is still not empty
$$$$$$$,
$$$$$$$ new __anext__
$$$$$$$(
$$$$$$$
...
$$$$$$$
$$$$$$$)
$$$$$$$ checks the exception class. If it's StopAsyncIteration it means
...
$$$$$$$
$$$$$$$)
$$$$$$$ is called after __anext__
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ was handled
$$$$$$$,
$$$$$$$ then if self.finished is
    True
$$$$$$$,
$$$$$$$ it raises StopIteration
$$$$$$$,
$$$$$$$ otherwise it acts like in step 2
$$$$$$$,
$$$$$$$ but if
...
$$$$$$$.
    ...
    for
$$$$$$$,
$$$$$$$ so we fire them with None when needed.
...
$$$$$$$:
$$$$$$$
        # This gets called when the result from aiterator.__anext__
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ is available.
...
$$$$$$$
        ...
        # If aiterator is exhausted
$$$$$$$,
$$$$$$$ _errback will be called.
        self.anext_deferred $= deferred_from_coro
$$$$$$$(
$$$$$$$self.aiterator.__anext__
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
$$$$$$$)
$$$$$$$
        self.anext_deferred.addCallbacks
$$$$$$$(
$$$$$$$self._callback
$$$$$$$,
$$$$$$$ self._errback
...
$$$$$$$
$$$$$$$"
$$$$$$$Converts a coroutine into a Deferred
$$$$$$$,
...
$$$$$$$:
$$$$$$$
            # wrapping the coroutine directly into a Deferred
$$$$$$$,
$$$$$$$ this doesn't work correctly with coroutines
            # that use asyncio
$$$$$$$,
$$$$$$$ e.g. 
$$$$$$$"
...
$$$$$$$ Converts a coroutine function into a function that returns a Deferred.
    ...
    This is useful for callback chains
$$$$$$$,
$$$$$$$ as callback functions are called with the previous callback result.
...
$$$$$$$ Converts a Deferred to something that can be awaited in a callback or other user coroutine.
    ...
    If the asyncio reactor is installed
$$$$$$$,
$$$$$$$ coroutines are wrapped into Futures
$$$$$$$,
$$$$$$$ and only Futures can be
    awaited inside them. Otherwise
$$$$$$$,
$$$$$$$ coroutines are wrapped into Deferreds and Deferreds can be awaited
