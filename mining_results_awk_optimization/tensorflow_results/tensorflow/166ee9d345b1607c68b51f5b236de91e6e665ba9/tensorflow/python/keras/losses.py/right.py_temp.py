...
$$$$$$$:
$$$$$$$
      y_pred $= tf.convert_to_tensor_v2
$$$$$$$(
$$$$$$$y_pred
$$$$$$$)
$$$$$$$
...
$$$$$$$ outside of built-in training loops
  such as `tf.keras` `compile` and `fit`
$$$$$$$,
$$$$$$$ please use 'SUM' or 'NONE' reduction
  types
$$$$$$$,
$$$$$$$ and reduce losses explicitly in your training loop. Using 'AUTO' or
...
$$$$$$$"
$$$$$$$
    losses_utils.ReductionV2.validate
$$$$$$$(
$$$$$$$reduction
$$$$$$$)
$$$$$$$
...
$$$$$$$
      ...
      self._name_scope $= self.name.strip
$$$$$$$(
$$$$$$$'_'
$$$$$$$)
$$$$$$$
...
$$$$$$$
      y_true
$$$$$$$:
$$$$$$$ Ground truth values. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN]`
...
$$$$$$$ .. dN-1]`
      y_pred
$$$$$$$:
$$$$$$$ The predicted values. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN]`
...
$$$$$$$ Optional `sample_weight` acts as a coefficient for the
        loss. If a scalar is provided
$$$$$$$,
$$$$$$$ then the loss is simply scaled by the
...
$$$$$$$ .. dN-1]` 
$$$$$$$(
$$$$$$$or can be broadcasted to
        this shape
$$$$$$$)
$$$$$$$
$$$$$$$,
$$$$$$$ then each loss element of `y_pred` is scaled
        by the corresponding value of `sample_weight`. 
$$$$$$$(
$$$$$$$Note on`dN-1`
$$$$$$$:
$$$$$$$ all loss
          functions reduce by 1 dimension
$$$$$$$,
$$$$$$$ usually axis$=-1.
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
      Weighted loss float `Tensor`. If `reduction` is `NONE`
$$$$$$$,
$$$$$$$ this has
        shape `[batch_size
$$$$$$$,
...
$$$$$$$(
$$$$$$$Note `dN-1`
        because all loss functions reduce by 1 dimension
$$$$$$$,
$$$$$$$ usually axis$=-1.
$$$$$$$)
$$$$$$$
...
$$$$$$$
$$$$$$$"
$$$$$$$Instantiates a `Loss` from its config 
$$$$$$$(
...
$$$$$$$:
$$$$$$$
      Loss values with the shape `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN-1]`.
...
$$$$$$$
    if 
$$$$$$$(
$$$$$$$not self._allow_sum_over_batch_size and
...
$$$$$$$"
$$$$$$$
    if tensor_util.is_tf_type
$$$$$$$(
$$$$$$$y_pred
$$$$$$$)
$$$$$$$ and tensor_util.is_tf_type
$$$$$$$(
$$$$$$$y_true
$$$$$$$)
$$$$$$$
...
$$$$$$$
      y_pred
$$$$$$$,
$$$$$$$ y_true $= losses_utils.squeeze_or_expand_dimensions
$$$$$$$(
$$$$$$$y_pred
$$$$$$$,
$$$$$$$ y_true
...
$$$$$$$:
$$$$$$$
      config[k] $= backend.eval
$$$$$$$(
$$$$$$$v
$$$$$$$)
$$$$$$$ if tf_utils.is_tensor_or_variable
$$$$$$$(
$$$$$$$v
$$$$$$$)
$$$$$$$ else v
...
$$$$$$$Computes the cross-entropy loss between true labels and predicted labels.
  ...
  Use this cross-entropy loss for binary 
$$$$$$$(
$$$$$$$0 or 1
$$$$$$$)
...
$$$$$$$** 
$$$$$$$(
$$$$$$$set `from_logits$=False`
$$$$$$$)
$$$$$$$

  >>> # Make the following updates to the above 
$$$$$$$"
$$$$$$$Recommended Usage
$$$$$$$"
$$$$$$$ section
...
$$$$$$$,
$$$$$$$ we
          assume that `y_pred` contains probabilities 
$$$$$$$(
$$$$$$$i.e.
$$$$$$$,
$$$$$$$ values in [0
...
$$$$$$$ where the smoothing squeezes the labels towards 0.5.
      ...
      axis
$$$$$$$:
$$$$$$$ The axis along which to compute crossentropy 
$$$$$$$(
$$$$$$$the features axis
$$$$$$$)
$$$$$$$.
...
$$$$$$$,
$$$$$$$ there is `# classes` floating pointing values per
...
$$$$$$$,
$$$$$$$
        meaning the confidence on label values are relaxed. For example
$$$$$$$,
$$$$$$$ if
        `0.1`
$$$$$$$,
...
$$$$$$$ please use `CategoricalCrossentropy` loss.
  ...
  In the snippet below
$$$$$$$,
$$$$$$$ there is a single floating point value per example for
...
$$$$$$$`
  ...
  `y_true` values are expected to be -1 or 1. If binary 
$$$$$$$(
$$$$$$$0 or 1
$$$$$$$)
$$$$$$$ labels are
...
$$$$$$$ A float
$$$$$$$,
$$$$$$$ the point where the Huber loss function changes from a
        quadratic to linear.
      reduction
$$$$$$$:
$$$$$$$ Type of `tf.keras.losses.Reduction` to apply to
...
$$$$$$$Computes the mean squared error between labels and predictions.
  ...
  After computing the squared distance between the inputs
$$$$$$$,
$$$$$$$ the mean value over
...
$$$$$$$:
$$$$$$$
    Mean squared error values. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN-1]`.
...
$$$$$$$"
$$$$$$$
  y_pred $= ops.convert_to_tensor_v2_with_dispatch
$$$$$$$(
$$$$$$$y_pred
$$$$$$$)
$$$$$$$
...
$$$$$$$
    y_pred_extra_dim
$$$$$$$:
$$$$$$$ whether y_pred has an additional dimension compared to
      y_true
...
$$$$$$$(
$$$$$$$per-batch loss value
$$$$$$$)
$$$$$$$; a ragged tensor otherwise.
...
$$$$$$$)
$$$$$$$
    if ragged_output and not isinstance
$$$$$$$(
$$$$$$$r
$$$$$$$,
$$$$$$$ ragged_tensor.RaggedTensor
...
$$$$$$$:
$$$$$$$
      r $= ragged_tensor.RaggedTensor.from_tensor
$$$$$$$(
$$$$$$$r
$$$$$$$)
$$$$$$$
    elif not ragged_output and isinstance
$$$$$$$(
$$$$$$$r
$$$$$$$,
$$$$$$$ ragged_tensor.RaggedTensor
...
$$$$$$$
  ...
  nested_splits_list $= [rt.nested_row_splits for rt in 
$$$$$$$(
$$$$$$$y_true
$$$$$$$,
$$$$$$$ y_pred
...
$$$$$$$slist
$$$$$$$)
$$$$$$$ for slist in nested_splits_list]
    if rdims[0] $=$= rdims[1] - 1
$$$$$$$:
$$$$$$$
      nested_splits_list[1] $= nested_splits_list[1][
$$$$$$$:
$$$$$$$-1]
...
$$$$$$$
  ...
  assertion_list $= ragged_util.assert_splits_match
$$$$$$$(
$$$$$$$nested_splits_list
$$$$$$$)
$$$$$$$
...
$$$$$$$
    y_true
$$$$$$$:
$$$$$$$ RaggedTensor truth values. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN]`.
    y_pred
$$$$$$$:
$$$$$$$ RaggedTensor predicted values. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN]`.
...
$$$$$$$,
$$$$$$$ .. dN-1]`.
    When the number of dimensions of the batch feature vector [d0
$$$$$$$,
$$$$$$$ .. dN] is
...
$$$$$$$:
$$$$$$$
    Mean absolute error values. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN-1]`.
...
$$$$$$$:
$$$$$$$
    Mean absolute percentage error values. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN-1]`.
...
$$$$$$$:
$$$$$$$
    Mean squared logarithmic error values. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN-1]`.
...
$$$$$$$0 or 1
$$$$$$$)
$$$$$$$ labels are provided we will convert them to -1 or 1.
      shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
...
$$$$$$$:
$$$$$$$
     Squared hinge loss values. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN-1]`.
...
$$$$$$$0 or 1
$$$$$$$)
$$$$$$$ labels are provided they will be converted to -1 or 1.
      shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
...
$$$$$$$:
$$$$$$$
    Hinge loss values. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN-1]`.
...
$$$$$$$)
$$$$$$$
  abs_error $= math_ops.abs
$$$$$$$(
$$$$$$$error
$$$$$$$)
$$$$$$$
  half $= ops.convert_to_tensor_v2_with_dispatch
$$$$$$$(
$$$$$$$0.5
$$$$$$$,
$$$$$$$ dtype$=abs_error.dtype
$$$$$$$)
$$$$$$$
  return backend.mean
$$$$$$$(
...
$$$$$$$,
$$$$$$$
                         delta * abs_error - half * math_ops.square
$$$$$$$(
$$$$$$$delta
$$$$$$$)
$$$$$$$
...
$$$$$$$` for large `x`. This means that 'logcosh' works mostly
  like the mean squared error
$$$$$$$,
$$$$$$$ but will not be so strongly affected by the
...
$$$$$$$:
$$$$$$$
    Logcosh error values. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN-1]`.
...
$$$$$$$ Float in [0
$$$$$$$,
$$$$$$$ 1]. If > `0` then smooth the labels. For
      example
$$$$$$$,
$$$$$$$ if `0.1`
$$$$$$$,
$$$$$$$ use `0.1 / num_classes` for non-target labels
...
$$$$$$$.
  ...
  When used by CategoricalCrossentropy
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ with the default reduction
...
$$$$$$$
$$$$$$$,
$$$$$$$ the reduction averages the loss over the
  number of elements independent of the batch. E.g. if the RaggedTensor
  has 2 batches with [2
$$$$$$$,
$$$$$$$ 1] values respectivly the resulting loss is
...
$$$$$$$.
      ...
      When used by SparseCategoricalCrossentropy
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ with the default reduction
...
$$$$$$$ Float in [0
$$$$$$$,
$$$$$$$ 1]. If > `0` then smooth the labels by
      squeezing them towards 0.5 That is
$$$$$$$,
$$$$$$$ using `1. - 0.5 * label_smoothing`
...
$$$$$$$:
$$$$$$$
    Binary crossentropy loss value. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN-1]`.
...
$$$$$$$ sequence_len
$$$$$$$)
$$$$$$$ with sequence_len being variable
  per batch.
  Return shape
$$$$$$$:
$$$$$$$ 
...
$$$$$$$
$$$$$$$)
$$$$$$$; returns the per batch mean of the loss values.

  When used by BinaryCrossentropy
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$ with the default reduction
...
$$$$$$$
$$$$$$$,
$$$$$$$ the reduction averages the per batch losses over
...
$$$$$$$:
$$$$$$$
     Poisson loss value. shape $= `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN-1]`.
...
$$$$$$$(
$$$$$$$
      y_pred - y_true * math_ops.log
$$$$$$$(
$$$$$$$y_pred + backend.epsilon
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$Computes the cosine similarity between labels and predictions.
  ...
  between -1 and 0
$$$$$$$,
$$$$$$$ 0 indicates orthogonality and values closer to -1
  indicate greater similarity. The values closer to 1 indicate greater
  dissimilarity. This makes it usable as a loss function in a setting
  where you try to maximize the proximity between predictions and
  targets. If either `y_true` or `y_pred` is a zero vector
$$$$$$$,
$$$$$$$ cosine
...
$$$$$$$ 0 indicates orthogonality and values closer to -1
  ...
  If either `y_true` or `y_pred` is a zero vector
$$$$$$$,
...
$$$$$$$ Type of `tf.keras.losses.Reduction` to apply to loss.
      ...
      `SUM_OVER_BATCH_SIZE`. When used with `tf.distribute.Strategy`
$$$$$$$,
$$$$$$$ outside of
      built-in training loops such as `tf.keras` `compile` and `fit`
$$$$$$$,
$$$$$$$ using
...
def is_categorical_crossentropy
$$$$$$$(
$$$$$$$loss
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$ and
              loss.__name__ $=$= 'categorical_crossentropy'
$$$$$$$)
$$$$$$$ or
...
$$$$$$$(
$$$$$$$
      f'Could not interpret loss function identifier
$$$$$$$:
$$$$$$$ {identifier}'
$$$$$$$)
$$$$$$$
