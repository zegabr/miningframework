...
class _AugmentedGraphView
$$$$$$$(
$$$$$$$graph_view.ObjectGraphView
$$$$$$$)
$$$$$$$
$$$$$$$:
$$$$$$$
...
$$$$$$$An extendable graph which also tracks functions attached to objects.
  ...
  generated from it
$$$$$$$,
$$$$$$$ even if they are not dependencies of the node they were
  ...
  Also tracks functions attached to objects in the graph
$$$$$$$,
$$$$$$$ through the caching
  `list_functions` method. Enumerating functions only through this method
  ensures that we get a consistent view of functions
$$$$$$$,
$$$$$$$ even if object attributes
...
$$$$$$$
$$$$$$$"
$$$$$$$Attach an object to `parent_node`
$$$$$$$,
$$$$$$$ overriding any existing dependency.
$$$$$$$"
$$$$$$$
$$$$$$$"
$$$$$$$
...
$$$$$$$"
$$$$$$$
    extra_dependencies $= self.list_extra_dependencies
$$$$$$$(
$$$$$$$obj
$$$$$$$)
$$$$$$$
...
$$$$$$$ which is always added
        # when saving
$$$$$$$)
$$$$$$$ should not have naming conflicts with dependencies
        # defined by the user.
...
$$$$$$$
    for name
$$$$$$$,
$$$$$$$ dep in extra_dependencies.items
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
    return obj._list_extra_dependencies_for_serialization
$$$$$$$(
$$$$$$$  # pylint
$$$$$$$:
$$$$$$$ disable$=protected-access
...
$$$$$$$:
$$$$$$$
    obj_functions $= self._functions.get
$$$$$$$(
$$$$$$$obj
$$$$$$$,
$$$$$$$ None
...
$$$$$$$,
$$$$$$$ for example adding objects
$$$$$$$,
$$$$$$$ must happen in
  `checkpoint_view` 
$$$$$$$(
$$$$$$$an `_AugmentedGraphView`
$$$$$$$)
$$$$$$$ before the `_SaveableView` is
...
$$$$$$$ A GraphView object.
      options
$$$$$$$:
$$$$$$$ A SaveOptions instance.
      wrapped_functions
$$$$$$$:
$$$$$$$ Dictionary that maps concrete functions to functions
...
$$$$$$$
    ...
    # functions. When writing the SavedFunction protos
$$$$$$$,
$$$$$$$ the names of the
...
$$$$$$$
        for original
$$$$$$$,
$$$$$$$ wrapped in self._wrapped_functions.items
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$}
...
$$$$$$$
  ...
  def _initialize_nodes_and_concrete_functions
$$$$$$$(
$$$$$$$self
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
      for function in self.checkpoint_view.list_functions
$$$$$$$(
$$$$$$$obj
$$$$$$$)
$$$$$$$.values
...
$$$$$$$and TPU/Mirrored
$$$$$$$)
$$$$$$$ variables are automatically revived with
      # their saveables defined
$$$$$$$,
$$$$$$$ so there is no need to trace the save
...
$$$$$$$
      ...
      saveable_map $= saveable_object_util.trace_save_restore_functions
$$$$$$$(
$$$$$$$obj
$$$$$$$)
$$$$$$$
...
$$$$$$$
        for save_fn
$$$$$$$,
$$$$$$$ restore_fn in saveable_map.values
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$"
$$$$$$$Found untraced functions such as %s while saving 
$$$$$$$(
$$$$$$$showing %d of %d
$$$$$$$)
$$$$$$$.
...
$$$$$$$:
$$$$$$$
        self.concrete_functions.append
$$$$$$$(
$$$$$$$concrete_function
$$$$$$$)
$$$$$$$
        self._seen_function_names.add
$$$$$$$(
$$$$$$$concrete_function.name
$$$$$$$)
$$$$$$$

  def _trace_all_concrete_functions
$$$$$$$(
$$$$$$$self
$$$$$$$)
$$$$$$$
...
$$$$$$$
      ...
      - force side effects of creation of concrete functions
$$$$$$$,
$$$$$$$ e.g. create
...
$$$$$$$Populate the nodes
$$$$$$$,
$$$$$$$ children and slot_variables of a SavedObjectGraph.
$$$$$$$"
$$$$$$$
$$$$$$$"
$$$$$$$
...
$$$$$$$
        continue
      for child in self.checkpoint_view.list_dependencies
$$$$$$$(
$$$$$$$node
$$$$$$$)
$$$$$$$
...
$$$$$$$(
$$$$$$$
          self.checkpoint_view.list_functions
$$$$$$$(
$$$$$$$node
$$$$$$$)
$$$$$$$.items
...
$$$$$$$Makes new resource handle ops corresponding to existing resource tensors.
    ...
    Creates resource handle ops in the current default graph
$$$$$$$,
$$$$$$$ whereas
    `accessible_objects` will be from an eager context. Resource mapping adds
    resource handle ops to the main GraphDef of a SavedModel
$$$$$$$,
$$$$$$$ which allows the
...
$$$$$$$
        object_map
$$$$$$$:
$$$$$$$ A dictionary mapping from object in `accessible_objects` to
          replacement objects created to hold the new resource tensors.
        resource_map
$$$$$$$:
$$$$$$$ A dictionary mapping from resource tensors extracted from
          `accessible_objects` to newly created resource tensors.
        asset_info
$$$$$$$:
$$$$$$$ An _AssetInfo tuple describing external assets referenced
...
$$$$$$$
$$$$$$$:
$$$$$$$ Handle MirroredVariables and other types of variables which
...
$$$$$$$
        node_object_map
$$$$$$$,
$$$$$$$ node_resource_map $= obj._map_resources
$$$$$$$(
$$$$$$$self._options
$$$$$$$)
$$$$$$$  # pylint
...
$$$$$$$
    ...
    # Note
$$$$$$$:
$$$$$$$ some concrete functions can have been realized when tracing other
    # functions
$$$$$$$,
$$$$$$$ and might closure-capture tensors from their parent functions.
    # This is normal
$$$$$$$,
$$$$$$$ but it means those concrete functions can't be serialized
    # as their own independent endpoints
$$$$$$$,
...
$$$$$$$
$$$$$$$"
$$$$$$$Unable to save function {name} for the following reason
$$$$$$$(
$$$$$$$s
$$$$$$$)
$$$$$$$
...
$$$$$$$.join
$$$$$$$(
$$$$$$$concrete_function.graph.saving_errors
$$$$$$$)
$$$$$$$
$$$$$$$)
$$$$$$$.format
...
$$$$$$$
            ...
            # value
$$$$$$$,
$$$$$$$ rebuidling the constant op specifically with the shape arg
$$$$$$$,
$$$$$$$
            # since otherwise the whole array is written into the node def
$$$$$$$,
$$$$$$$
            # causing performance and graph proto size issues 
$$$$$$$(
$$$$$$$protos cannot be
            # bigger than 2GB
$$$$$$$)
...
def _tensor_dict_to_tensorinfo
$$$$$$$(
$$$$$$$tensor_dict
$$$$$$$)
$$$$$$$
...
$$$$$$$
  return {
      key
$$$$$$$:
$$$$$$$ utils_impl.build_tensor_info_internal
$$$$$$$(
$$$$$$$value
$$$$$$$)
$$$$$$$
...
$$$$$$$
    original_captures
$$$$$$$:
$$$$$$$ A dictionary mapping from tensors captured by the
      function to interior placeholders for those tensors 
$$$$$$$(
$$$$$$$inside the function
      body
$$$$$$$)
$$$$$$$.
    resource_map
$$$$$$$:
$$$$$$$ A dictionary mapping from resource tensors owned by the eager
      context to resource tensors in the exported graph.

  Returns
$$$$$$$:
$$$$$$$
    A list of stand-in tensors which belong to the exported graph
$$$$$$$,
$$$$$$$ corresponding
...
$$$$$$$
  ...
  for exterior
$$$$$$$,
$$$$$$$ interior in original_captures
$$$$$$$:
$$$$$$$
    mapped_resource $= resource_map.get
$$$$$$$(
$$$$$$$exterior
$$$$$$$,
$$$$$$$ None
...
$$$$$$$
      ...
      # needs attaching.
      for primary_referrer in gc.get_referrers
$$$$$$$(
$$$$$$$exterior
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
          trackable_referrers.append
$$$$$$$(
$$$$$$$primary_referrer
$$$$$$$)
$$$$$$$
        for secondary_referrer in gc.get_referrers
$$$$$$$(
$$$$$$$primary_referrer
$$$$$$$)
$$$$$$$
...
$$$$$$$obj
$$$$$$$)
$$$$$$$ for obj in trackable_referrers]
$$$$$$$)
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$Creates exterior placeholders in the exported graph for function arguments.
  ...
  Functions have two types of inputs
$$$$$$$:
$$$$$$$ tensors captured from the outside 
$$$$$$$(
$$$$$$$eager
$$$$$$$)
$$$$$$$
  context
$$$$$$$,
$$$$$$$ and arguments to the function which we expect to receive from the
  user at each call. `_map_captures_to_created_tensors` replaces
  captured tensors with stand-ins 
$$$$$$$(
$$$$$$$typically these are resource dtype tensors
  associated with variables
$$$$$$$)
$$$$$$$. `_map_function_inputs_to_created_inputs` runs over
  every argument
$$$$$$$,
$$$$$$$ creating a new placeholder for each which will belong to the
...
$$$$$$$
    function_arguments
$$$$$$$:
$$$$$$$ A list of argument placeholders in the function body.
    signature_key
$$$$$$$:
$$$$$$$ The name of the signature being exported
$$$$$$$,
$$$$$$$ for error messages.
    function_name
$$$$$$$:
...
$$$$$$$
      mapped_inputs
$$$$$$$:
$$$$$$$ A list with entries corresponding to `function_arguments`
        containing all of the inputs of the function gathered from the exported
        graph 
$$$$$$$(
$$$$$$$both captured resources and arguments
$$$$$$$)
$$$$$$$.
      exterior_argument_placeholders
$$$$$$$:
$$$$$$$ A dictionary mapping from argument names
        to placeholders in the exported graph
$$$$$$$,
$$$$$$$ containing the explicit arguments
...
$$$$$$$
    ValueError
$$$$$$$:
$$$$$$$ If argument names are not unique.
...
$$$$$$$
  ...
  # function body
$$$$$$$,
$$$$$$$ directly contained in a MetaGraph of the SavedModel. The
  # function body itself contains nearly identical placeholders used when
  # running the function
$$$$$$$,
$$$$$$$ but these exterior placeholders allow Session-based
...
$$$$$$$:
$$$$$$$
    # `export_captures` contains an exhaustive set of captures
$$$$$$$,
$$$$$$$ so if we don't
...
$$$$$$$
    ...
    # uniquified by TensorFlow
$$$$$$$,
$$$$$$$ then a single user-specified argument name
    # must refer to multiple Tensors. The resulting signatures would be
    # confusing to call. Instead
$$$$$$$,
$$$$$$$ we throw an exception telling the user to
...
$$$$$$$,
$$$$$$$ since concrete functions may not be
...
$$$$$$$signature '{}'
$$$$$$$:
$$$$$$$ more than one argument to '{}' was named '{}'. 
$$$$$$$"
$$$$$$$
           
$$$$$$$"
$$$$$$$Signatures have one Tensor per named input
$$$$$$$,
$$$$$$$ so to have 
$$$$$$$"
$$$$$$$
...
$$$$$$$ name$=...
$$$$$$$)
$$$$$$$ to provide a name for a Tensor 
$$$$$$$"
$$$$$$$
...
def _call_function_with_mapped_captures
$$$$$$$(
$$$$$$$function
$$$$$$$,
$$$$$$$ args
...
$$$$$$$
$$$$$$$"
$$$$$$$Calls `function` in the exported graph
$$$$$$$,
$$$$$$$ using mapped resource captures.
$$$$$$$"
$$$$$$$
$$$$$$$"
$$$$$$$
...
$$$$$$$(
$$$$$$$function.graph.captures
$$$$$$$,
$$$$$$$
                                                     resource_map
$$$$$$$)
$$$$$$$
  # Calls the function quite directly
$$$$$$$,
$$$$$$$ since we have new captured resource
  # tensors we need to feed in which weren't part of the original function
  # definition.
  # pylint
$$$$$$$:
$$$$$$$ disable$=protected-access
  outputs $= function._call_flat
$$$$$$$(
$$$$$$$args
$$$$$$$,
$$$$$$$ export_captures
...
$$$$$$$
    signature_functions
$$$$$$$:
$$$$$$$ A dictionary mapping string keys to concrete TensorFlow
      functions 
$$$$$$$(
$$$$$$$e.g. from `signature_serialization.canonicalize_signatures`
$$$$$$$)
$$$$$$$
      which will be used to generate SignatureDefs.
    resource_map
$$$$$$$:
$$$$$$$ A dictionary mapping from resource tensors in the eager
...
$$$$$$$
    ...
    placeholder Tensors
$$$$$$$,
$$$$$$$ generating a function call operation and output
    Tensors. The placeholder Tensors
$$$$$$$,
...
$$$$$$$ and the
    ...
    `signature_functions`
$$$$$$$,
$$$$$$$ with the concrete functions replaced by SignatureDefs
    ...
    function as a MetaGraph in a SavedModel
$$$$$$$,
...
def _trace_resource_initializers
$$$$$$$(
$$$$$$$accessible_objects
$$$$$$$)
$$$$$$$
...
$$$$$$$
  ...
  original_path $= tensor_util.constant_value
$$$$$$$(
...
$$$$$$$
$$$$$$$:
$$$$$$$ Instead of mapping 1-1 between trackable asset
...
$$$$$$$)
$$$$$$$
  asset_info.asset_index[trackable_asset] $= len
$$$$$$$(
$$$$$$$asset_info.asset_defs
$$$$$$$)
$$$$$$$ - 1
...
$$$$$$$
    meta_graph_def
$$$$$$$:
$$$$$$$ The MetaGraphDef proto to fill.
    saveable_view
$$$$$$$:
$$$$$$$ The _SaveableView being exported.
    signature_functions
$$$$$$$:
$$$$$$$ A dictionary mapping signature keys to concrete
...
$$$$$$$ Graph
$$$$$$$)
$$$$$$$ containing the captured assets and
...
$$$$$$$ resource_map
$$$$$$$,
$$$$$$$ asset_info $= saveable_view.map_resources
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$
    ...
    meta_graph_def.collection_def[
        pywrap_libexport.MAIN_OP_KEY].node_list.value.append
$$$$$$$(
$$$$$$$init_op.name
$$$$$$$)
$$$$$$$
...
$$$$$$$
                init_op
$$$$$$$,
$$$$$$$ pywrap_libexport.INIT_OP_SIGNATURE_KEY
$$$$$$$)
$$$$$$$
$$$$$$$)
$$$$$$$
  ...
  # variables
$$$$$$$,
$$$$$$$ but want any operations associated with the save/restore to be in
  # the exported graph 
$$$$$$$(
$$$$$$$thus the `to_graph` argument
$$$$$$$)
$$$$$$$.
...
$$$$$$$)
$$$$$$$
    meta_graph_def.saver_def.CopyFrom
$$$$$$$(
$$$$$$$saver_def
$$$$$$$)
$$$$$$$
  graph_def $= exported_graph.as_graph_def
$$$$$$$(
$$$$$$$add_shapes$=True
$$$$$$$)
$$$$$$$
...
$$$$$$$
  ...
  meta_graph_def.graph_def.CopyFrom
$$$$$$$(
$$$$$$$graph_def
$$$$$$$)
$$$$$$$
...
$$$$$$$(
$$$$$$$
      meta_graph.stripped_op_list_for_graph
$$$$$$$(
...
$$$$$$$)
$$$$$$$
  meta_graph_def.asset_file_def.extend
$$$$$$$(
$$$$$$$asset_info.asset_defs
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
    meta_graph_def.signature_def[signature_key].CopyFrom
$$$$$$$(
$$$$$$$signature
$$$$$$$)
$$$$$$$
  meta_graph.strip_graph_default_valued_attrs
$$$$$$$(
$$$$$$$meta_graph_def
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
    utils_impl.swap_function_tensor_content
$$$$$$$(
$$$$$$$meta_graph_def
$$$$$$$,
$$$$$$$ 
...
$$$$$$$(
$$$$$$$meta_graph.ops_used_by_graph_def
$$$$$$$(
$$$$$$$graph_def
$$$$$$$)
$$$$$$$
...
$$$$$$$"
$$$$$$${}.\nPlease verify that these ops should be saved
$$$$$$$,
$$$$$$$ since they must be 
$$$$$$$"
$$$$$$$
...
$$$$$$$"
$$$$$$$available when loading the SavedModel. If loading from Python
$$$$$$$,
$$$$$$$ you 
$$$$$$$"
$$$$$$$
...
$$$$$$$"
$$$$$$$must import the library defining these ops. From C++
$$$$$$$,
$$$$$$$ link the custom 
$$$$$$$"
$$$$$$$
...
$$$$$$$"
$$$$$$$ops to the serving binary. Once you've confirmed this
$$$$$$$,
$$$$$$$ please add the 
$$$$$$$"
$$$$$$$
...
$$$$$$$)
$$$$$$$
  saveable_view.fill_object_graph_proto
$$$$$$$(
$$$$$$$proto
$$$$$$$)
$$$$$$$
...
$$$$$$$)
$$$$$$$
    name $= saveable_view.function_name_map.get
$$$$$$$(
$$$$$$$name
$$$$$$$,
$$$$$$$ name
...
$$$$$$$:
$$$$$$$
      proto.concrete_functions[name].CopyFrom
$$$$$$$(
$$$$$$$serialized
$$$$$$$)
$$$$$$$
...
$$$$$$$
  ...
  elif resource_variable_ops.is_resource_variable
$$$$$$$(
$$$$$$$obj
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$
    proto.resource.device $= obj._resource_device  # pylint
$$$$$$$:
$$$$$$$ disable$=protected-access
  else
$$$$$$$:
$$$$$$$
    registered_type_proto $= revived_types.serialize
$$$$$$$(
$$$$$$$obj
$$$$$$$)
$$$$$$$
...
$$$$$$$:
$$$$$$$enable$=protected-access
    proto.user_object.CopyFrom
$$$$$$$(
$$$$$$$registered_type_proto
$$$$$$$)
$$$$$$$
...
$$$$$$$
    exported_graph
$$$$$$$:
$$$$$$$ A Graph that has been created by tracing a saveable view.
    export_dir
$$$$$$$:
$$$$$$$ SavedModel directory in which to write the debug info.
...
$$$$$$$(
$$$$$$$
          utils_impl.get_or_create_debug_dir
$$$$$$$(
$$$$$$$export_dir
$$$$$$$)
$$$$$$$
...
$$$$$$$https
$$$$$$$:
$$$$$$$//www.tensorflow.org/api_docs/python/tf/Module
$$$$$$$)
$$$$$$$ 
$$$$$$$(
$$$$$$$and subclasses
...
$$$$$$$https
$$$$$$$:
$$$$$$$//www.tensorflow.org/guide/saved_model#the_savedmodel_format_on_disk
$$$$$$$)
$$$$$$$.
...
$$$$$$$https
$$$$$$$:
$$$$$$$//github.com/tensorflow/tensorflow/blob/master/tensorflow/python/training/tracking/base.py#L591
$$$$$$$)
$$$$$$$.
...
$$$$$$$
  ...
  The resulting SavedModel is then servable with an input named 
$$$$$$$"
$$$$$$$x
$$$$$$$"
$$$$$$$
...
$$$$$$$ a scalar
  ...
  available to programs which consume `SavedModel`s
$$$$$$$,
$$$$$$$ for example
$$$$$$$,
$$$$$$$ serving
...
$$$$$$$input_signature$=...
$$$$$$$)
$$$$$$$` and passed as signatures directly
$$$$$$$,
$$$$$$$ or
...
$$$$$$$
  ...
  `get_concrete_function` is not called on that method
$$$$$$$,
...
$$$$$$$ Found zero restored functions for caller function.
  ...
  If the `signatures` argument is omitted
$$$$$$$,
$$$$$$$ `obj` will be searched for
  `@tf.function`-decorated methods. If exactly one traced `@tf.function` is
  found
$$$$$$$,
$$$$$$$ that method will be used as the default signature for the SavedModel.
  Else
$$$$$$$,
$$$$$$$ any `@tf.function` attached to `obj` or its dependencies will be
...
$$$$$$$ `Tensor` arguments are
  ...
  The outputs of functions used as `signatures` must either be flat lists
$$$$$$$,
$$$$$$$ in
  which case outputs will be numbered
$$$$$$$,
$$$$$$$ or a dictionary mapping string keys to
  `Tensor`
$$$$$$$,
...
$$$$$$$ `tf.saved_model.save`
  ...
  While Keras has its own [saving and loading API]
$$$$$$$(
$$$$$$$https
$$$$$$$:
...
$$$$$$$,
$$$$$$$
  this function can be used to export Keras models. For example
$$$$$$$,
$$$$$$$ exporting with
...
$$$$$$$
  ...
  argument. If neither are specified
$$$$$$$,
$$$$$$$ the model's forward pass is exported.
...
$$$$$$$ 5]
  ...
  object or to an attribute of `obj` directly. TensorFlow objects 
$$$$$$$(
$$$$$$$e.g. layers
...
$$$$$$$ track their variables
  ...
  uses
$$$$$$$,
$$$$$$$ and an exported `Checkpoint` object may be restored as a training
...
$$$$$$$ subdirectory.
  ...
  body
$$$$$$$,
$$$$$$$ instead of using the calling context's device. This means for example
...
$$$$$$$,
$$$$$$$ may cause issues.
    * For `ConcreteFunctions`
$$$$$$$,
$$$$$$$ active distribution strategies will cause device
...
$$$$$$$https
$$$$$$$:
$$$$$$$//github.com/tensorflow/tensorflow/blob/master/tensorflow/python/saved_model/README.md#stripping-default-valued-attributes
$$$$$$$)
$$$$$$$
  automatically
$$$$$$$,
$$$$$$$ which removes one source of incompatibilities when the consumer
  of a SavedModel is running an older TensorFlow version than the
  producer. There are however other sources of incompatibilities which are not
  handled automatically
$$$$$$$,
$$$$$$$ such as when the exported model contains operations
...
$$$$$$$ A trackable object 
$$$$$$$(
$$$$$$$e.g. tf.Module or tf.train.Checkpoint
$$$$$$$)
$$$$$$$ to export.
    export_dir
$$$$$$$:
...
$$$$$$$:
$$$$$$$
      * a `tf.function` with an input signature specified
$$$$$$$,
$$$$$$$ which will use the
...
$$$$$$$
      * the result of `f.get_concrete_function` on a `@tf.function`-decorated
        function `f`
$$$$$$$,
$$$$$$$ in which case `f` will be used to generate a signature for
        the SavedModel under the default serving signature key
$$$$$$$,
$$$$$$$
      * a dictionary
$$$$$$$,
$$$$$$$ which maps signature keys to either `tf.function`
        instances with input signatures or concrete functions. Keys of such a
        dictionary may be arbitrary strings
$$$$$$$,
$$$$$$$ but will typically be from the
...
$$$$$$$ A directory in which to write the SavedModel.
    signatures
$$$$$$$:
$$$$$$$ A function or dictionary of functions to save in the SavedModel
      as signatures.
    options
$$$$$$$:
$$$$$$$ `tf.saved_model.SaveOptions` object for configuring save options.
...
$$$$$$$:
$$$$$$$ Whether to raise the metadata warning. This arg will
      be removed in TF 2.5.
    experimental_skip_checkpoint
$$$$$$$:
$$$$$$$ If set to `True`
$$$$$$$,
$$$$$$$ the checkpoint will not
      be written.
...
$$$$$$$
    A tuple of 
$$$$$$$(
$$$$$$$a list of saved nodes in the order they are serialized to the
      `SavedObjectGraph`
$$$$$$$,
$$$$$$$ dictionary mapping nodes to one possible path from
...
$$$$$$$
$$$$$$$:
$$$$$$$ Factor out some subset of SavedModelBuilder which is 2.x
  # compatible 
$$$$$$$(
$$$$$$$no sessions
$$$$$$$)
$$$$$$$ and share it with this export API rather than
...
$$$$$$$,
$$$$$$$ copy assets into the assets directory
$$$$$$$,
$$$$$$$ and write out
...
$$$$$$$:
$$$$$$$
    utils_impl.get_or_create_variables_dir
$$$$$$$(
$$$$$$$export_dir
$$$$$$$)
$$$$$$$
...
$$$$$$$
$$$$$$$)
$$$$$$$  # Ensure save operations have completed.
...
$$$$$$$
      compat.as_str
$$$$$$$(
$$$$$$$pywrap_libexport.SAVED_MODEL_FILENAME_PB
$$$$$$$)
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$
  ...
  # Clean reference cycles so repeated export
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$s don't make work for the garbage
  # collector. Before this point
$$$$$$$,
$$$$$$$ we need to keep references to captured
...
$$$$$$$Exports the MetaGraph proto of the `obj` to a file.
  ...
  produce the given object's MetaGraph
$$$$$$$,
$$$$$$$ then saves it to the given file. It
  skips saving checkpoint information
$$$$$$$,
$$$$$$$ and is useful when all one wants is the
...
$$$$$$$
    obj
$$$$$$$:
$$$$$$$ A trackable object to build the MetaGraph from.
    filename
$$$$$$$:
$$$$$$$ The file into which to write the MetaGraph.
    signatures
$$$$$$$:
$$$$$$$ Optional
$$$$$$$,
$$$$$$$ either a `tf.function` with an input signature
      ...
      `@tf.function`-decorated function `f`
$$$$$$$,
$$$$$$$ in which case `f` will be used to
      generate a signature for the SavedModel under the default serving
      signature key. `signatures` may also be a dictionary
$$$$$$$,
$$$$$$$ in which case it
...
$$$$$$$
  ...
  checkpoint_graph_view $= _AugmentedGraphView
$$$$$$$(
$$$$$$$obj
$$$$$$$)
$$$$$$$
...
$$$$$$$(
$$$$$$$
      signature_serialization.canonicalize_signatures
$$$$$$$(
$$$$$$$signatures
$$$$$$$)
$$$$$$$
$$$$$$$)
$$$$$$$
  signature_serialization.validate_saveable_view
$$$$$$$(
$$$$$$$checkpoint_graph_view
$$$$$$$)
$$$$$$$
...
$$$$$$$
  asset_info
$$$$$$$,
$$$$$$$ exported_graph $= _fill_meta_graph_def
$$$$$$$(
$$$$$$$meta_graph_def
$$$$$$$,
$$$$$$$
...
$$$$$$$
    ...
    for alias
$$$$$$$,
$$$$$$$ func in options.function_aliases.items
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
$$$$$$$:
$$$$$$$
      for fdef in func._stateful_fn._function_cache.all_values
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$ disable$=protected-access
      ...
      for fdef in func._stateless_fn._function_cache.all_values
$$$$$$$(
$$$$$$$
$$$$$$$)
$$$$$$$
...
$$$$$$$ disable$=protected-access
  ...
  object_graph_proto
$$$$$$$,
$$$$$$$ saved_object_metadata $= _serialize_object_graph
$$$$$$$(
$$$$$$$
      saveable_view
$$$$$$$,
...
$$$$$$$)
$$$$$$$
  meta_graph_def.object_graph_def.CopyFrom
$$$$$$$(
$$$$$$$object_graph_proto
$$$$$$$)
$$$$$$$
...
$$$$$$$
        'FOR KERAS USERS
$$$$$$$:
$$$$$$$ The object that you are saving contains one or more '
...
$$$$$$$)
$$$$$$$. Please change your code to save '
        'with `tf.keras.models.save_model` or `model.save`
$$$$$$$,
$$$$$$$ and confirm that '
        'the file 
$$$$$$$"
$$$$$$$keras.metadata
$$$$$$$"
$$$$$$$ exists in the export directory. In the '
        'future
$$$$$$$,
$$$$$$$ Keras will only load the SavedModels that have this file. In '
        'other words
$$$$$$$,
$$$$$$$ `tf.saved_model.save` will no longer write SavedModels '
        'that can be recovered as Keras models 
$$$$$$$(
$$$$$$$this will apply in TF 2.5
$$$$$$$)
$$$$$$$.'
        '\n\nFOR DEVS
$$$$$$$:
$$$$$$$ If you are overwriting _tracking_metadata in your class
$$$$$$$,
$$$$$$$'
        ' this property has been used to save metadata in the SavedModel. The '
        'metadta field will be deprecated soon
$$$$$$$,
$$$$$$$ so please move the metadata to '
        'a different file.'
$$$$$$$)
$$$$$$$
...
$$$$$$$ Can be a `tf.function` with an input signature specified or the
      ...
      `f`. `signatures` may also be a dictionary
$$$$$$$,
$$$$$$$ in which case it maps from
      signature keys to `tf.function` instances. If None
$$$$$$$,
$$$$$$$ finds signature to
...
$$$$$$$ Optional
$$$$$$$,
$$$$$$$ the MetaGraphDef proto fill.
    raise_metadata_warning
$$$$$$$:
$$$$$$$ Whether to raise a warning when user objects contain
      non-empty metadata.
...
$$$$$$$
    AssertionError
$$$$$$$:
$$$$$$$ If `export_meta_graph` is executing inside a `tf.function`.
    ValueError
$$$$$$$:
$$$$$$$ If `obj` is not trackable.
...
$$$$$$$
    meta_graph_def
$$$$$$$:
$$$$$$$ Filled MetaGraphDef proto
    exported_graph
$$$$$$$:
$$$$$$$ `tf.Graph` object generated from `obj`.
    object_saver
$$$$$$$:
$$$$$$$ `util.TrackableSaver` of the `obj` and its dependencies.
    asset_info
$$$$$$$:
$$$$$$$ `_AssetInfo` tuple containing external assets in the `obj`.
