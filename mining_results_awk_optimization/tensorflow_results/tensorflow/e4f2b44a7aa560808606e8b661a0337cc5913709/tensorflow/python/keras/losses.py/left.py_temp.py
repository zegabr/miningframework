...
$$$$$$$:
$$$$$$$
      y_pred $= ops.convert_to_tensor_v2
$$$$$$$(
$$$$$$$y_pred
$$$$$$$)
$$$$$$$
...
$$$$$$$ Optional `sample_weight` acts as a
        coefficient for the loss. If a scalar is provided
$$$$$$$,
$$$$$$$ then the loss is
...
$$$$$$$ then the total loss for each sample of the batch is
        ...
        the shape of `sample_weight` is `[batch_size
$$$$$$$,
$$$$$$$ d0
$$$$$$$,
$$$$$$$ .. dN-1]` 
...
$$$$$$$"
$$$$$$$
    if tensor_util.is_tensor
$$$$$$$(
$$$$$$$y_pred
$$$$$$$)
$$$$$$$ and tensor_util.is_tensor
$$$$$$$(
$$$$$$$y_true
$$$$$$$)
$$$$$$$
...
$$$$$$$
      y_pred
$$$$$$$,
$$$$$$$ y_true $= tf_losses_util.squeeze_or_expand_dimensions
$$$$$$$(
$$$$$$$
          y_pred
$$$$$$$,
...
$$$$$$$. For each example
$$$$$$$,
$$$$$$$ there should be a single floating-point value
  per prediction.

  In the snippet below
$$$$$$$,
$$$$$$$ each of the four examples has only a single
  floating-pointing value
$$$$$$$,
$$$$$$$ and both `y_pred` and `y_true` have the shape
  `[batch_size]`.
...
$$$$$$$)
$$$$$$$
  label_smoothing $= ops.convert_to_tensor_v2
$$$$$$$(
$$$$$$$label_smoothing
$$$$$$$,
$$$$$$$ dtype$=K.floatx
...
$$$$$$$ where 0 indicates
  ...
  is a zero vector
$$$$$$$,
$$$$$$$ cosine similarity will be 0 regardless of the proximity
