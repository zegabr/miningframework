...
<<<<<<< /home/ze/miningframework/mining_results_awk_optimization_no_overlap/scrapy_results/scrapy/1cd953e1b064454eef40e55734b9d20b1daf67c9/scrapy/core/spidermw.py/left.py
...
||||||| /home/ze/miningframework/mining_results_awk_optimization_no_overlap/scrapy_results/scrapy/1cd953e1b064454eef40e55734b9d20b1daf67c9/scrapy/core/spidermw.py/base.py
    def scrape_response(self, scrape_func, response, request, spider):
    ...
    def _process_spider_input(self, scrape_func, response, request, spider):
        for method in self.methods['process_spider_input']:
            try:
                result = method(response=response, spider=spider)
                if result is not None:
>>>>>>> /home/ze/miningframework/mining_results_awk_optimization_no_overlap/scrapy_results/scrapy/1cd953e1b064454eef40e55734b9d20b1daf67c9/scrapy/core/spidermw.py/right.py
                    msg = (f"Middleware {_fname(method)} must return None "
                           f"or raise an exception, got {type(result)}")
                    raise _InvalidOutput(msg)
            except _InvalidOutput:
