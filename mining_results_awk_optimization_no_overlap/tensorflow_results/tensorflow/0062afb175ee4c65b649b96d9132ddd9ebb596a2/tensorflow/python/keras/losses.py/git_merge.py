...
class LossFunctionWrapper(Loss):
  ...
  def get_config(self):
    config = {}
<<<<<<< /home/ze/miningframework/mining_results_awk_optimization_no_overlap/tensorflow_results/tensorflow/0062afb175ee4c65b649b96d9132ddd9ebb596a2/tensorflow/python/keras/losses.py/left.py
    for k, v in self._fn_kwargs.items():
      config[k] = K.eval(v) if tf_utils.is_tensor_or_variable(v) else v
    base_config = super().get_config()
||||||| /home/ze/miningframework/mining_results_awk_optimization_no_overlap/tensorflow_results/tensorflow/0062afb175ee4c65b649b96d9132ddd9ebb596a2/tensorflow/python/keras/losses.py/base.py
...
=======
    ...
    base_config = super(LossFunctionWrapper, self).get_config()
>>>>>>> /home/ze/miningframework/mining_results_awk_optimization_no_overlap/tensorflow_results/tensorflow/0062afb175ee4c65b649b96d9132ddd9ebb596a2/tensorflow/python/keras/losses.py/right.py
