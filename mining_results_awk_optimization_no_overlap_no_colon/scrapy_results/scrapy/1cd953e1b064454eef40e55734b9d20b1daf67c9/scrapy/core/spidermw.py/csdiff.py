...
class SpiderMiddlewareManager(MiddlewareManager):
    ...
    def _evaluate_iterable(self, response, spider, iterable, exception_processor_index, recover_to):
            def _process_exception(ex):
                exception_result = process_spider_exception(response, spider, Failure(ex),
        ...
        def process_spider_exception(self, response, spider, _failure, start_index=0):
    ...
    def _process_callback_output(self, response, spider, result):
        ...
        result = self._evaluate_iterable(response, spider, result, 0, recovered)
            return iter_class(self, scrape_func, response, request, spider):
