...
||||||| /home/ze/miningframework/mining_results_awk_optimization_no_overlap_no_colon/scrapy_results/scrapy/a0101361e2e8d9c86e74d46876d79a5ed18a9224/scrapy/core/spidermw.py/base.py
def _fname(f):
    return f"{f.__self__.__class__.__name__}.{f.__func__.__name__}"
