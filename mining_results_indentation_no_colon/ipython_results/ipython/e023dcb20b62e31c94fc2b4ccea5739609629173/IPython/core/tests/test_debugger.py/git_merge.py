...
||||||| /home/ze/miningframework/mining_results_indentation_no_colon/ipython_results/ipython/e023dcb20b62e31c94fc2b4ccea5739609629173/IPython/core/tests/test_debugger.py/base.py
        if called[0] == 1:
            raise KeyboardInterrupt()
        else:
