...
||||||| /home/ze/miningframework/mining_results_version3_2/flask_results/flask/864875099762fd0209bacbb26985ce2bcd7f2ec0/src/flask/helpers.py/base.py
        with self.lock:
...
class _PackageBoundObject(object):
    ...
    def open_resource(self, resource, mode="rb"):
        """Opens a resource from the application's resource folder.  To see
        how this works, consider the following folder structure::
>>>>>>> /home/ze/miningframework/mining_results_version3_2/flask_results/flask/864875099762fd0209bacbb26985ce2bcd7f2ec0/src/flask/helpers.py/right.py
