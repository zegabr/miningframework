...
./gradlew assemble
./gradlew run --args="-e .py -i injectors.CSDiffModule -l '( ) ,' -t 1 -s 01/01/2021 -u 02/01/2021 ./python_projects_backup.csv ./v2_results"
...
./gradlew assemble
./gradlew run --args="-e .py -i injectors.CSDiffModule -l '( ) ,' -t 1 -s 01/01/2021 -u 02/01/2021 ./python_projects_backup.csv ./awk_results"
