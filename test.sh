...
# echo "results removed"
# ./gradlew run --args="-e .py -i injectors.CSDiffModule -l '( ) : ,' -s 01/09/2021 -u 01/01/2022 ./projects/ansible.csv /home/ze/Desktop/mining_results/ansible_results"
...
# echo "results removed"
# ./gradlew run --args="-e .py -i injectors.CSDiffModule -l '( ) : ,' -s 01/01/2021 -u 01/01/2022 ./projects/compose.csv /home/ze/Desktop/mining_results/compose_results"
...
# echo "results removed"
# ./gradlew run --args="-e .py -i injectors.CSDiffModule -l '( ) : ,' -s 01/01/2021 -u 01/01/2022 ./projects/django.csv /home/ze/Desktop/mining_results/django_results"
...
# echo "results removed"
# ./gradlew run --args="-e .py -i injectors.CSDiffModule -l '( ) : ,' -s 01/01/2021 -u 01/01/2022 ./projects/pyspider.csv /home/ze/Desktop/mining_results/pyspider_results"
...
# echo "results removed"
# ./gradlew run --args="-e .py -i injectors.CSDiffModule -l '( ) : ,' -s 01/01/2021 -u 01/01/2022 ./projects/scikit-learn.csv /home/ze/Desktop/mining_results/scikit-learn_results"
