...
results_path="$miningframework_path/mining_results_speedtest"
...
do
    ...
    time ./gradlew run --args="-e .py -i injectors.CSDiffModule -l '( ) , :' -t 1 -s 01/01/2021 -u 03/01/2021 ./projects/${i}.csv "$results_path"/${i}_results"
    ...
    #     bash "$miningframework_path"/re_run_csdiff.sh
    # fi
